<?php
class AlipayuserAction extends UserAction{
	...
	public function post(){
		...
		$body = $subject;
		$data=M('Indent')->data(			
		array('user_id'=>session('user_id'),'month'=>intval($this->_post('num')),'title'=>$subject,'name'=>$this->_post('uname'),'gid'=>$this->_post('gid'),'create_time'=>time(),'order'=>$out_trade_no,'price'=>$total_fee))->add();
