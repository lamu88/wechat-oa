function upyunPicUpload(domid,width,height,token){
	...
	art.dialog.open('/index.php?g=User&m=Upyun&a=upload&token='+token+'&width='+width,{lock:false,title:'上传图片',width:550,height:330,yesText:'关闭',background: '#000',opacity: 0.87});
}
