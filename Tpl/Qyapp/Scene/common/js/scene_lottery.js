    ...
    function loadUser(){
        var url = '/index.php?g=Qyapp&m=Scene&a=loadUser';
...
/*     $("#prize_rank").change( function() {
        var val = $(this).val();
        var url = '/index.php?g=Qyapp&m=Scene&a=prize_data';
        $('.lottery-right').html('');
        if(val != ''){
    ...
    $('.button-run').click(function(){
        ...
        var url = '/index.php?g=Qyapp&m=Scene&a=get_lottery';
        if(prize_id){  
    ...
    $('.button-stop').click(function(){
        ...
        clearInterval(interval);
        var prize_id = $('#prize_rank').val();
        var url      = '/index.php?g=Qyapp&m=Scene&a=lottery_ok';
