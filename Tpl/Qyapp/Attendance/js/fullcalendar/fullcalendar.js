...
var Grid = fc.Grid = RowRenderer.extend({
	...
	bgCellHtml: function(cell) {
		...
		return '<td style="vertical-align: middle;" class="' + classes.join(' ') + '"' +
...
var BasicView = View.extend({
	...
	renderHtml: function() {
		return '' +
			'<table>' +
				'<thead class="fc-head">' +
					'<tr>' +
						'<td valign="center" class="' + this.widgetHeaderClass + '">' +
				...
				'<tbody class="fc-body">' +
					'<tr>' +
						'<td style="vertical-align: middle;" class="' + this.widgetContentClass + '">' +
	...
	dayIntroHtml: function() {
		if (this.weekNumbersVisible) {
			return '<td valign="center" class="fc-week-number ' + this.widgetContentClass + '" ' +
	...
	introHtml: function() {
		if (this.weekNumbersVisible) {
			return '<td valign="center" class="fc-week-number" ' + this.weekNumberStyleAttr() + '></td>';
		}
	},
	...
	numberCellHtml: function(cell) {
		...
		return '' +
			'<td valign="center" class="' + classes.join(' ') + '" data-date="' + date.format() + '">' +
				date.date() +
			'</td>';
	},
...
var AgendaView = View.extend({
	...
	dayIntroHtml: function() {
		return '' +
			'<td valign="center" class="fc-axis ' + this.widgetContentClass + '" ' + this.axisStyleAttr() + '>' +
				'<span>' + // needed for matchCellWidths
	...
	slotBgIntroHtml: function() {
		return '<td valign="center" class="fc-axis ' + this.widgetContentClass + '" ' + this.axisStyleAttr() + '></td>';
	},
	...
	introHtml: function() {
		return '<td valign="center" class="fc-axis" ' + this.axisStyleAttr() + '></td>';
	},
