    ...
    $.fn.date = function (options,Ycallback,Ncallback) {
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="setcancle">'+
                '<ul>'+
                '<li id="dateconfirm"><img src="./Tpl/Qyapp/Leave/images/que.png"></li>'+
                '<li id="datecancle"><img src="./Tpl/Qyapp/Leave/images/close.png"> </li>'+
                '</ul>'+
                '</div>'+
                '</footer>'+
                ...
                '<ul></ul>'+
                '</div>'+
                '<div id="monthwrapper" class="month">'+
                '<ul></ul>'+
                '</div>'+
                '<div id="daywrapper">'+
                '<ul></ul>'+
