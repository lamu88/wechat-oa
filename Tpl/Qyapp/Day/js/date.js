...
(function ($) {
    $.fn.date = function (options,Ycallback,Ncallback) {
        ...
        function  createUL(){
            ...
            $("#daywrapper ul").html(createMONTH_UL());
        }
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="setcancle">'+
                '<ul>'+
                '<li id="dateconfirm"><img src="Tpl/Qyapp/Applyflow/images/que.png"></li>'+
                '<li id="datecancle"><img src="Tpl/Qyapp/Applyflow/images/close.png"> </li>'+
                '</ul>'+
                '</div>'+
                '</footer>'+
