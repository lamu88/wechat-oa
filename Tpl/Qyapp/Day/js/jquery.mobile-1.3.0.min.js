...
function(a, b, c, d) { (function(a) {
    ...
    function(a, b, d) {
        ...
        a.fn.jqmData = function(b, c) {
            var e;
            return typeof b != "undefined" && (b && (b = a.mobile.nsNormalize(b)), arguments.length < 2 || c === d ? e = this.data(b) : e = this.data(b, c)),
            e
        },
    ...
    function(a, b) {
        ...
        a.widget("mobile.loader", {
            ...
            checkLoaderPosition: function() {
                ...
                if (b.top < c || b.top - c > d) this.element.addClass("ui-loader-fakefix"),
                this.fakeFixLoader(),
            ...
            show: function(b, g, h) {
                var i, j, k, l;
                this.resetHtml(),
                a.type(b) === "object" ? (l = a.extend({},
                this.options, b), b = l.theme || a.mobile.loadingMessageTheme) : (l = this.options, b = b || a.mobile.loadingMessageTheme || l.theme),
                j = g || a.mobile.loadingMessage || l.text,
                e.addClass("ui-loading");
                if (a.mobile.loadingMessage !== !1 || l.html) a.mobile.loadingMessageTextVisible !== d ? i = a.mobile.loadingMessageTextVisible: i = l.textVisible,
    ...
    function(a, b, d) {
        ...
        g = function() {
            function n() {
                var c = k(),
                d = m(h);
                c !== h ? (l(h = c, d), a(b).trigger(e)) : d !== h && (location.href = location.href.replace(/#.*/, "") + d),
    ...
    function(a, b) {
        ...
        a.event.special.navigate = d = {
            ...
            setup: function(a, b) {
                if (d.bound) return;
                d.bound = !0,
                d.isPushStateEnabled() ? (d.originalEventName = "popstate", c.bind("popstate.navigate", d.popstate)) : d.isHashChangeEnabled() && (d.originalEventName = "hashchange", c.bind("hashchange.navigate", d.hashchange))
            }
        }
    } (a),
    function(a, c) {
    ...
    function(a, d) {
        ...
        a.extend(a.mobile.Navigator.prototype, {
            ...
            go: function(d, f, g) {
                ...
                this.squash(d, h), g || (this.ignorePopState = !0, a.mobile.window.trigger(k))),
    ...
    function(a) {
        ...
        c = function() {
            f = (new Date).getTime(),
            g = f - d,
            g >= b ? (d = f, a(this).trigger("throttledresize")) : (e && clearTimeout(e), e = setTimeout(c, b - g))
        },
        d = 0,
        e,
        f,
    ...
    function(a, d) {
        function w(b) { !! j && (!j.closest("." + a.mobile.activePageClass).length || b) && j.removeClass(a.mobile.activeBtnClass),
            j = null
        }
        function x() {
            o = !1,
        ...
        e.bind(a.support.pushState ? "popstate": "hashchange",
        function() {
            y = !1
        }),
        e.one(a.support.pushState ? "popstate": "hashchange",
        function() {
            y = !0
        }),
        e.one("pagecontainercreate",
        function() {
        ...
        a.mobile.loadPage = function(b, c) {
            ...
            f.data && f.type === "get" && (j = h.addSearchParams(j, f.data), f.data = d),
            ...
            if (g.length === 0) if (a.mobile.firstPage && h.isFirstPageUrl(k)) a.mobile.firstPage.parent().length && (g = a(a.mobile.firstPage));
            else if (h.isEmbeddedPage(k)) return e.reject(j, c),
            e.promise();
            if (g.length) {
                if (!f.reloadPage) return C(g, f.role),
                e.resolve(j, c, g),
                e.promise();
                i = g
            }
            ...
            !a.mobile.allowCrossDomainPages && !h.isSameDomain(r, j) ? e.reject(j, c) : a.ajax({
                ...
                success: function(d, m, n) {
                    ...
                    r && !g.jqmData("title") && (~r.indexOf("&") && (r = a("<div>" + r + "</div>").text()), g.jqmData("title", r));
                ...
                error: function(b, d, g) {
                    ...
                    f.showLoadMsg && (q(), a.mobile.showPageLoadingMsg(a.mobile.pageLoadErrorMessageTheme, a.mobile.pageLoadErrorMessage, !0), setTimeout(a.mobile.hidePageLoadingMsg, 1500)),
                    e.reject(j, c)
                }
            }),
            e.promise()
        ...
        a.mobile.changePage = function(b, e) {
            ...
            var f = a.extend({},
            a.mobile.changePage.defaults, e),
            g;
            f.pageContainer = f.pageContainer || a.mobile.pageContainer,
            ...
            var G = u ? b.jqmData("title") || b.children(":jqmData(role='header')").find(".ui-title").getEncodedText() : z; !! G && z === c.title && (z = G),
            ...
            if (q && !f.fromHashChange) {
                var H; ! h.isPath(q) && q.indexOf("#") < 0 && (q = "#" + q),
                H = {
        ...
        a.mobile._registerInternalEvents = function() {
            ...
            function(b) {
                ...
                d.length > 0 && !d.hasClass("ui-disabled") && (w(!0), j = d, j.addClass(a.mobile.activeBtnClass))
            }),
            ...
            function(c) {
                ...
                if (f.is(":jqmData(rel='back')")) return a.mobile.back(),
                !1;
                var i = F(f),
    ...
    function(a, b, c) {
        a.widget("mobile.dialog", a.mobile.widget, {
            ...
            _setCloseBtn: function(b) {
                ...
                b !== "none" && (e = b === "left" ? "left": "right", d = a("<a href='#' class='ui-btn-" + e + "' data-" + a.mobile.ns + "icon='delete' data-" + a.mobile.ns + "iconpos='notext'>" + this.options.closeBtnText + "</a>"), this.element.children().find(":jqmData(role='header')").first().prepend(d), this._createComplete && a.fn.buttonMarkup && d.buttonMarkup(), this._createComplete = !0, d.bind("click",
                function() {
                    c.close()
        ...
        function(b) {
            ...
            a(":jqmData(role='header'), :jqmData(role='footer'), :jqmData(role='content')", c).jqmEnhanceable().each(function() {
                ...
                if (g === "header" || g === "footer") {
                    ...
                    g === "header" && (j = b.children("a, button"), k = j.hasClass("ui-btn-left"), l = j.hasClass("ui-btn-right"), k = k || j.eq(0).not(".ui-btn-right").addClass("ui-btn-left").length, l = l || j.eq(1).addClass("ui-btn-right").length),
    ...
    function(a, b) {
        a.mobile.behaviors.addFirstLastClasses = {
            _getVisibles: function(a, b) {
                var c;
                return b ? c = a.not(".ui-screen-hidden") : (c = a.filter(":visible"), c.length === 0 && (c = a.not(".ui-screen-hidden"))),
                c
            },
    ...
    function(a, b) {
        a.fn.grid = function(b) {
            return this.each(function() {
                ...
                g = d.grid,
                h;
                if (!g) if (e.length <= 5) for (var i in f) f[i] === e.length && (g = i);
                else g = "a",
    ...
    function(a, b) {
        ...
        a.fn.buttonMarkup = function(e) {
            ...
            for (var j = 0; j < f.length; j++) {
                ...
                d(l, h + "rel") === "popup" && k.attr("href") && (l.setAttribute("aria-haspopup", !0), l.setAttribute("aria-owns", k.attr("href"))),
                w = a.data(l.tagName === "INPUT" || l.tagName === "BUTTON" ? l.parentNode: l, "buttonElements"),
                w ? (l = w.outer, k = a(l), t = w.inner, u = w.text, a(w.icon).remove(), w.icon = null, r = w.hover, s = w.state) : (t = c.createElement(m.wrapperEls), u = c.createElement(m.wrapperEls)),
                ...
                m.icon && (m.icon = "ui-icon-" + m.icon, m.iconpos = m.iconpos || "left", q = "ui-icon " + m.icon, m.iconshadow && (q += " ui-icon-shadow")),
                m.iconpos && (p += " ui-btn-icon-" + m.iconpos, m.iconpos === "notext" && !k.attr("title") && k.attr("title", k.getEncodedText())),
            ...
            a.mobile.document.bind({
                "vmousedown vmousecancel vmouseup vmouseover vmouseout focus blur scrollstart": function(g) {
                    ...
                    if (j.length) {
                        ...
                        else if (l === "vmouseout" || l === "blur" || l === "scrollstart") f(j, "ui-btn-hover-" + i + " ui-btn-down-" + i, "ui-btn-up-" + i, !1, "up"),
                        d && clearTimeout(d),
                        h && clearTimeout(h)
                    }
                },
    ...
    function(a, b) {
        ...
        a.widget("mobile.listview", a.mobile.widget, {
            ...
            refresh: function(b) {
                ...
                l && (n || n === 0 ? m ? v = parseInt(n, 10) : (w = parseInt(n, 10) - 1, e.css("counter-reset", "listnumbering " + w)) : m && (v = 1)),
                ...
                E = k.length; D < E; D++) {
                    ...
                    l && m && q.indexOf("ui-li-divider") < 0 && (y = q.indexOf("ui-li-static") > 0 ? p: p.find(".ui-link-inherit"), y.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>" + v+++". </span>")),
                    o[q] || (o[q] = []),
                    o[q].push(p[0])
                }
    ...
    function(a, b) {
        a.widget("mobile.checkboxradio", a.mobile.widget, {
            ...
            _updateAll: function() {
                var b = this;
                this._getInputSet().each(function() {
                    var c = a(this); (this.checked || b.inputtype === "checkbox") && c.trigger("change")
    ...
    function(a, b) {
        a.widget("mobile.button", a.mobile.widget, {
            ...
            _create: function() {
                ...
                !~b[0].className.indexOf("ui-btn-left") || (e = "ui-btn-left"),
                !~b[0].className.indexOf("ui-btn-right") || (e = "ui-btn-right");
            ...
            _setOption: function(b, c) {
                var d = {};
                d[b] = c,
                b !== "initSelector" && (this.button.buttonMarkup(d), this.element.attr("data-" + (a.mobile.ns || "") + b.replace(/([A-Z])/, "-$1").toLowerCase(), c)),
    ...
    function(a, d) {
        ...
        a.widget("mobile.popup", a.mobile.widget, {
            ...
            _handleDocumentFocusIn: function(b) {
                ...
                if (d !== f.container[0]) {
                    e = a(b.target);
                    if (0 === e.parents().filter(f.container[0]).length) return a(c.activeElement).one("focus",
                    function(a) {
                        e.blur()
                    }),
            ...
            _create: function() {
                ...
                e && (b.screen.attr("id", e + "-screen"), b.container.attr("id", e + "-popup"), b.placeholder.html("<!-- placeholder for " + e + " -->")),
            ...
            _applyTransition: function(b) {
                ...
                b && b !== "none" && (this._fallbackTransition = a.mobile._maybeDegradeTransition(b), this._fallbackTransition === "none" && (this._fallbackTransition = ""), this._ui.container.addClass(this._fallbackTransition))
            },
            ...
            _desiredCoords: function(b) {
                ...
                h = b.y,
                i = b.positionTo;
                if (i && i !== "origin") if (i === "window") g = e.cx / 2 + e.x,
                h = e.cy / 2 + e.y;
                else {
                    try {
                        c = a(i)
            ...
            _closePopup: function(c, d) {
                ...
                c && c.type === "pagebeforechange" && d && (typeof d.toPage == "string" ? e = d.toPage: e = d.toPage.jqmData("url"), e = a.mobile.path.parseUrl(e), f = e.pathname + e.search + e.hash, this._myUrl !== a.mobile.path.makeUrlAbsolute(f) ? h = !0 : c.preventDefault()),
            ...
            open: function(c) {
                ...
                if (!e.history) {
                    ...
                    d.element.delegate(e.closeLinkSelector, e.closeLinkEvents,
                    function(a) {
                        d.close(),
                        a.preventDefault()
                    });
                ...
                f.indexOf(g) === -1 && !i ? f = f + (f.indexOf("#") > -1 ? g: "#" + g) : f = a.mobile.path.parseLocation().hash + g,
        ...
        a.widget("mobile.panel", a.mobile.widget, {
            ...
            _create: function() {
                ...
                g = function() {
                    ...
                    return c.length === 0 && (c = d.children(".ui-header:not(:jqmData(position='fixed')), .ui-content:not(:jqmData(role='popup')), .ui-footer:not(:jqmData(position='fixed'))").wrapAll('<div class="' + b.options.classes.contentWrap + " " + e() + '" />').parent(), a.support.cssTransform3d && !!b.options.animate && c.addClass(b.options.classes.animate)),
                    c
                },
                h = function() {
                    var c = d.find("." + b.options.classes.contentFixedToolbar);
                    return c.length === 0 && (c = d.find(".ui-header:jqmData(position='fixed'), .ui-footer:jqmData(position='fixed')").addClass(b.options.classes.contentFixedToolbar), a.support.cssTransform3d && !!b.options.animate && c.addClass(b.options.classes.animate)),
                    c
                };
                a.extend(this, {
                    _panelID: c.attr("id"),
            ...
            _createModal: function(b) {
                var c = this;
                c._modal = a("<div class='" + c.options.classes.modal + "' data-panelid='" + c._panelID + "'></div>").on("mousedown",
                function() {
                    c.close()
                }).appendTo(this._page)
            },
            ...
            _bindSwipeEvents: function() {
                var a = this,
                b = a._modal ? a.element.add(a._modal) : a.element; ! a.options.swipeClose || (a.options.position === "left" ? b.on("swipeleft.panel",
                function(b) {
                    a.close()
            ...
            open: function(b) {
                if (!this._open) {
                    ...
                    c._page.jqmData("panel") === "open" ? c._page.on("panelclose",
                    function() {
                        e()
                    }) : e(),
                    c._open = !0
    ...
    function(a, b) {
        ...
        a.mobile.document.delegate(":jqmData(role='table')", "tablecreate",
        function() {
            var b = a(this),
    ...
    function(a) {
        ...
        a.mobile.zoom = a.extend({},
        {
            enabled: !f,
            locked: !1,
            disable: function(c) { ! f && !a.mobile.zoom.locked && (b.attr("content", d), a.mobile.zoom.enabled = !1, a.mobile.zoom.locked = c || !1)
            },
            enable: function(c) { ! f && (!a.mobile.zoom.locked || c === !0) && (b.attr("content", e), a.mobile.zoom.enabled = !0, a.mobile.zoom.locked = !1)
            },
            restore: function() {
    ...
    function(a, b) {
        a.widget("mobile.textinput", a.mobile.widget, {
            ...
            _create: function() {
                ...
                m || h ? (j = a("<a href='#' class='ui-input-clear' title='" + k + "'>" + k + "</a>").bind("click",
                function(a) {
                    ...
                    shadow: !0,
                    mini: d.mini
                }), h || i.addClass("ui-input-has-clear"), o(), c.bind("paste cut keyup input focus change blur", o)) : !n && !h && c.addClass("ui-corner-all ui-shadow-inset" + f + g),
                c.focus(function() {
    ...
    function(a, b) {
        ...
        function() {
            ...
            f = function(e) {
                ...
                f.jqmData("lastval", g),
                n || g.length < j.length || g.indexOf(j) !== 0 ? h = b.children() : (h = b.children(":not(.ui-screen-hidden)"), !h.length && d.options.filterReveal && (h = b.children(".ui-screen-hidden")));
                if (g) {
                    for (var o = h.length - 1; o >= 0; o--) m = a(h[o]),
                    l = m.jqmData("filtertext") || m.text(),
                    m.is("li:jqmData(role=list-divider)") ? (m.toggleClass("ui-filter-hidequeue", !k), k = !1) : d.options.filterCallback(l, g, m) ? m.toggleClass("ui-filter-hidequeue", !0) : k = !0;
    ...
    function(a, d) {
        a.widget("mobile.slider", a.mobile.widget, {
            ...
            _create: function() {
                ...
                y = a(x),
                z = this.options.highlight && !this.isToggleSwitch ?
                function() {
                ...
                x.className = [this.isToggleSwitch ? "ui-slider ": "ui-slider-track ", m, " ui-btn-down-", i, " ui-btn-corner-all", u].join(""),
                v.className = "ui-slider-handle",
                x.appendChild(v),
                w.buttonMarkup({
                    corners: !0,
                    theme: h,
                ...
                if (this.isToggleSwitch) {
                    ...
                    for (var C = 0,
                    D = x.childNodes.length; C < D; C++) B.appendChild(x.childNodes[C]);
                    x.appendChild(B),
                    w.addClass("ui-slider-handle-snapping"),
                    A = f.find("option");
                    for (var E = 0,
                    F = A.length; E < F; E++) {
                        var G = E ? "a": "b",
                        ...
                        J.className = ["ui-slider-label ui-slider-label-", G, H, " ui-btn-corner-all"].join(""),
                        J.setAttribute("role", "img"),
                        J.appendChild(c.createTextNode(A[E].innerHTML)),
                        a(J).prependTo(y)
                    }
                    e._labels = a(".ui-slider-label", y)
                }
                q.addClass("ui-slider"),
                f.addClass(this.isToggleSwitch ? "ui-slider-switch": "ui-slider-input"),
                this._on(f, {
                ...
                y.bind("vmousedown", a.proxy(this._sliderVMouseDown, this)).bind("vclick", !1),
                this._on(c, {
            ...
            refresh: function(b, d, e) {
                ...
                h = this.options.theme || g,
                i = this.options.trackTheme || g;
                f.slider[0].className = [this.isToggleSwitch ? "ui-slider ui-slider-switch": "ui-slider-track", " ui-btn-down-" + i, " ui-btn-corner-all", this.options.mini ? " ui-mini": ""].join(""),
                ...
                this.handle[0].setAttribute("aria-valuenow", m ? v: n.eq(v).attr("value")),
                this.handle[0].setAttribute("aria-valuetext", m ? v: n.eq(v).getEncodedText()),
                ...
                if (!e) {
                    ...
                    if (this._trigger("beforechange", b) === !1) return ! 1; ! d && C && l.trigger("change")
                }
            },
            enable: function() {
                return this.element.attr("disabled", !1),
        ...
        a.widget("mobile.slider", a.mobile.slider, a.mobile.behaviors.formReset),
        a.mobile.document.bind("pagecreate create",
        function(b) {
    ...
    function(a, b) {
        a.widget("mobile.rangeslider", a.mobile.widget, {
            ...
            _slidedrag: function(b) {
                ...
                if (this._proxy === "first" && c || this._proxy === "last" && !c) return a.data(d.get(0), "mobileSlider").dragging = !0,
            ...
            _change: function(b) {
                if (b.type == "keyup") return this._updateHighlight(),
                !1;
                ...
                if (c > d && !this._sliderTarget) f.val(e ? d: c).slider("refresh"),
                this._trigger("normalize");
                else if (c > d) {
                    f.val(this._targetVal).slider("refresh");
                    var h = this;
                    setTimeout(function() {
                        g.val(e ? c: d).slider("refresh"),
                        a.data(g.get(0), "mobileSlider").handle.focus(),
                        h._sliderFirst.css("z-index", e ? "": 1),
                        h._trigger("normalize")
                    },
                    0),
                    this._proxy = e ? "first": "last"
                }
                c === d ? (a.data(f.get(0), "mobileSlider").handle.css("z-index", 1), a.data(g.get(0), "mobileSlider").handle.css("z-index", 0)) : (a.data(g.get(0), "mobileSlider").handle.css("z-index", ""), a.data(f.get(0), "mobileSlider").handle.css("z-index", "")),
                this._updateHighlight();
                if (c >= d) return ! 1
            },
    ...
    function(a, d) {
        a.widget("mobile.selectmenu", a.mobile.widget, {
            ...
            _create: function() {
                ...
                this.setButtonText(),
                d.nativeMenu && b.opera && b.opera.version && i.addClass("ui-select-nativeonly"),
                this.isMultiple && (this.buttonCount = a("<span>").addClass("ui-li-count ui-btn-up-c ui-btn-corner-all").hide().appendTo(i.addClass("ui-li-has-count"))),
        ...
        a.widget("mobile.selectmenu", a.mobile.selectmenu, a.mobile.behaviors.formReset),
        a.mobile.document.bind("pagecreate create",
        function(b) {
    ...
    function(a, b) {
        var d = function(d) {
            ...
            d.isMultiple && (x = a("<a>", {
                ...
                href: "#",
                "class": "ui-btn-left"
            }).attr("data-" + a.mobile.ns + "iconpos", "notext").attr("data-" + a.mobile.ns + "icon", "delete").appendTo(t).buttonMarkup()),
            a.extend(d, {
                select: d.select,
                selectID: g,
                buttonId: o,
                ...
                build: function() {
                    var c = this;
                    c.refresh(),
                    c._origTabIndex === b && (c._origTabIndex = c.select[0].getAttribute("tabindex") === null ? !1 : c.select.attr("tabindex")),
                    ...
                    function(b) {
                        ...
                        if (b.type === "vclick" || b.keyCode && (b.keyCode === a.mobile.keyCode.ENTER || b.keyCode === a.mobile.keyCode.SPACE)) c._decideFormat(),
                        c.menuType === "overlay" ? c.button.attr("href", "#" + c.popupID).attr("data-" + (a.mobile.ns || "") + "rel", "popup") : c.button.attr("href", "#" + c.dialogID).attr("data-" + (a.mobile.ns || "") + "rel", "dialog"),
                        c.isOpen = !0
                    }),
                    ...
                    function(b) {
                        ...
                        switch (b.keyCode) {
                        case 38:
                            return f = e.prev().not(".ui-selectmenu-placeholder"),
                            f.is(".ui-li-divider") && (f = f.prev()),
                            f.length && (c.blur().attr("tabindex", "-1"), f.addClass("ui-btn-down-" + d.options.theme).find("a").first().focus()),
                            !1;
                        case 40:
                            return g = e.next(),
                            g.is(".ui-li-divider") && (g = g.next()),
                            g.length && (c.blur().attr("tabindex", "-1"), g.addClass("ui-btn-down-" + d.options.theme).find("a").first().focus()),
                            !1;
                        case 13:
                        case 32:
                    ...
                    c.isMultiple && c.headerClose.click(function() {
                        if (c.menuType === "overlay") return c.close(),
                        !1
                    }),
                ...
                refresh: function(b, c) {
                    ...
                    e = this.element,
                    f = this.isMultiple,
                    g; (b || this._isRebuildRequired()) && d._buildList(),
                    ...
                    d.list.find("li:not(.ui-li-divider)").removeClass(a.mobile.activeBtnClass).attr("aria-selected", !1).each(function(b) {
                        if (a.inArray(b, g) > -1) {
                            ...
                            d.isMultiple ? c.find(".ui-icon").removeClass("ui-icon-checkbox-off").addClass("ui-icon-checkbox-on") : c.is(".ui-selectmenu-placeholder") ? c.next().addClass(a.mobile.activeBtnClass) : c.addClass(a.mobile.activeBtnClass)
                        }
                    })
                },
                close: function() {
                ...
                _decideFormat: function() {
                    function m() {
                        ...
                        c.length === 0 && (c = b.list.find("li.ui-btn:not( :jqmData(placeholder='true') ) a")),
                        c.first().focus().closest("li").addClass("ui-btn-down-" + d.options.theme)
                    }
                    var b = this,
                    c = a.mobile.window,
                    e = b.list.parent(),
                    ...
                    k = c.height(),
                    l = c.width();
                    f > k - 80 || !a.support.scrollTop ? (b.menuPage.appendTo(a.mobile.pageContainer).page(), b.menuPageContent = q.find(".ui-content"), b.menuPageClose = q.find(".ui-header a"), b.thisPage.unbind("pagehide.remove"), i === 0 && j > k && b.thisPage.one("pagehide",
                    function() {
                        a(this).jqmData("lastScroll", j)
                    }), b.menuPage.one("pageshow",
                    function() {
                        m()
                    }).one("pagehide",
                    function() {
                ...
                _buildList: function() {
                    ...
                    for (var u = 0; u < k; u++, s = !1) {
                        ...
                        v.disabled && (A.push("ui-disabled"), D.setAttribute("aria-disabled", !0)),
                        D.setAttribute(n, u),
                        D.setAttribute(o, i),
                        s && D.setAttribute(q, !0),
                        D.className = A.join(" "),
        ...
        function(b) {
            var c = a(b.target).data("mobile-selectmenu"); ! c.options.nativeMenu && c.element.parents(":jqmData(role='popup')").length === 0 && d(c)
        })
    } (a),
    function(a, b) {
        a.widget("mobile.fixedtoolbar", a.mobile.widget, {
            ...
            _create: function() {
                ...
                c.fullscreen ? (d.addClass("ui-" + e + "-fullscreen"), f.addClass("ui-page-" + e + "-fullscreen")) : f.addClass("ui-page-" + e + "-fixed"),
                a.extend(this, {
                    _thisPage: null
                }),
            ...
            _handlePageBeforeHide: function(b, c) {
                ...
                if (d.trackPersistentToolbars) {
                    ...
                    if (g.length || h.length) g.add(h).appendTo(a.mobile.pageContainer),
                    c.nextPage.one("pageshow",
                    function() {
                        h.prependTo(this),
                        g.appendTo(this)
                    })
    ...
    function(a, b) {
        a.widget("mobile.fixedtoolbar", a.mobile.fixedtoolbar, {
            ...
            _workarounds: function() {
                ...
                else if (e === "android" && d && d < 534) f._bindScrollWorkaround(),
    ...
    function(a, b) {
        function j(a) {
            ...
            g = Math.abs(i.y),
            h = Math.abs(i.z),
            !b.orientation && (f > 7 || (h > 6 && g < 8 || h < 8 && g > 6) && f > 5) ? d.enabled && d.disable() : d.enabled || d.enable()
        }
    ...
    function(a, b, d) {
        ...
        a.extend(a.mobile, {
            initializePage: function() {
                ...
                d.length || (d = a("body").wrapInner("<div data-" + a.mobile.ns + "role='page'></div>").children(0)),
                d.each(function() {
                    var b = a(this);
                    b.jqmData("url") || b.attr("data-" + a.mobile.ns + "url", b.attr("id") || location.pathname + location.search)
                }),
                a.mobile.firstPage = d.first(),
                a.mobile.pageContainer = a.mobile.firstPage.parent().addClass("ui-mobile-viewport"),
                g.trigger("pagecontainercreate"),
                a.mobile.showPageLoadingMsg(),
                h(),
                !a.mobile.hashListeningEnabled || !a.mobile.path.isHashValid(location.hash) || !a(f).is(':jqmData(role="page")') && !a.mobile.path.isPath(e) && e !== a.mobile.dialogHashKey ? (a.mobile.path.isHashValid(location.hash) && (a.mobile.urlHistory.initialDst = e.replace("#", "")), a.event.special.navigate.isPushStateEnabled() && a.mobile.navigate.navigator.squash(b.parseLocation().href), a.mobile.changePage(a.mobile.firstPage, {
                    transition: "none",
                    reverse: !0,
                    changeHash: !1,
                    fromHashChange: !0
        ...
        a(function() {
            b.scrollTo(0, 1),
            a.mobile.defaultHomeScroll = !a.support.scrollTop || a.mobile.window.scrollTop() === 1 ? 0 : 1,
