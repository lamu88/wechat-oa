...
$(function () {
    var url_rndprize = '/index.php?g=Apps&m=LuckyFruit&a=wap_getajax';
    ...
    $('.part').on('tap', '#submit-btn', function () {
        ...
        $.post('/index.php?g=Apps&m=LuckyFruit&a=wap_add', submitData,
        		function(data) {
    ...
    $('.part').on('tap', '#ver-btn', function () {
        ...
        $.post('/index.php?g=Apps&m=LuckyFruit&a=exchange', submitData,
        		function(data) {		            
	        		if (data.success == true) {
		                alert('恭喜，验证成功!');
		                setTimeout(function(){
