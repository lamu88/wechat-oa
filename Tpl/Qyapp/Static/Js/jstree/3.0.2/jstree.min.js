...
(function(e) {
    ...
    if (!e.jstree) {
        ...
        e.jstree.reference = function(i) {
            var r = null,
            s = null;
            if (i && i.id && (i = i.id), !s || !s.length) try {
                s = e(i)
            } catch(n) {}
            if (!s || !s.length) try {
        ...
        e.jstree.core.prototype = {
            plugin: function(t, i) {
                ...
                r.prototype = this, new r(i, this)) : this
            },
            init: function(t, i) {
                this._model = {
                    data: {
            ...
            bind: function() {
                ...
                this)).on("keydown.jstree", ".jstree-anchor", e.proxy(function(t) {
                    ...
                    case 37:
                        t.preventDefault(),
                        this.is_open(t.currentTarget) ? this.close_node(t.currentTarget) : (i = this.get_parent(t.currentTarget), i && "#" !== i.id && this.get_node(i, !0).children(".jstree-anchor").focus());
                        break;
                    case 38:
                        t.preventDefault(),
                    ...
                    if (i.status && ("#" !== i.node.id || this._data.core.loaded || (this._data.core.loaded = !0, this._firstChild(this.get_container_ul()[0]) && this.element.attr("aria-activedescendant", this._firstChild(this.get_container_ul()[0]).id), this.trigger("loaded")), !this._data.core.ready && !this.get_container_ul().find(".jstree-loading").length)) {
                        if (this._data.core.ready = !0, this._data.core.selected.length) {
                            if (this.settings.core.expand_selected_onload) {
                                ...
                                s,
                                n;
                                for (s = 0, n = this._data.core.selected.length; n > s; s++) r = r.concat(this._model.data[this._data.core.selected[s]].parents);
                                for (r = e.vakata.array_unique(r), s = 0, n = r.length; n > s; s++) this.open_node(r[s], !1, 0)
                            }
            ...
            get_path: function(e, t, i) {
                ...
                var r, s, n = [];
                for (n.push(i ? e.id: e.text), r = 0, s = e.parents.length; s > r; r++) n.push(i ? e.parents[r] : this.get_text(e.parents[r]));
            ...
            load_all: function(e, t) {
                ...
                n,
                a;
                for (e.state && !e.state.loaded && i.push(e.id), n = 0, a = s.length; a > n; n++) r[s[n]] && r[s[n]].state && !r[s[n]].state.loaded && i.push(s[n]);
                i.length ? this._load_nodes(i,
                function() {
                    this.load_all(e, t)
            ...
            _load_node: function(t, i) {
                var r = this.settings.core.data,
                s;
                return r ? e.isFunction(r) ? r.call(this, t, e.proxy(function(r) {
                    r === !1 && i.call(this, !1),
                    this["string" == typeof r ? "_append_html_data": "_append_json_data"](t, "string" == typeof r ? e(r) : r,
                    function(e) {
                        i.call(this, e)
                    })
                },
                this)) : "object" == typeof r ? r.url ? (r = e.extend(!0, {},
                r), e.isFunction(r.url) && (r.url = r.url.call(this, t)), e.isFunction(r.data) && (r.data = r.data.call(this, t)), e.ajax(r).done(e.proxy(function(r, s, n) {
                    var a = n.getResponseHeader("Content-Type");
                    return - 1 !== a.indexOf("json") || "object" == typeof r ? this._append_json_data(t, r,
                    function(e) {
                        i.call(this, e)
                    }) : -1 !== a.indexOf("html") || "string" == typeof r ? this._append_html_data(t, e(r),
                    function(e) {
                        i.call(this, e)
                ...
                this))) : (s = e.isArray(r) || e.isPlainObject(r) ? JSON.parse(JSON.stringify(r)) : r, "#" === t.id ? this._append_json_data(t, s,
                function(e) {
                    i.call(this, e)
                }) : (this._data.core.last_error = {
                    error: "nodata",
                ...
                this.settings.core.error.call(this, this._data.core.last_error), i.call(this, !1))) : "string" == typeof r ? "#" === t.id ? this._append_html_data(t, e(r),
                function(e) {
                    i.call(this, e)
                }) : (this._data.core.last_error = {
                    error: "nodata",
            ...
            _append_json_data: function(t, i, r, s) {
                ...
                d = function(e, t) {
                    ...
                    m = function(e, i, r) {
                        ...
                        if (_.li_attr.id || (_.li_attr.id = s), e && "object" == typeof e.a_attr) for (n in e.a_attr) e.a_attr.hasOwnProperty(n) && (_.a_attr[n] = e.a_attr[n]);
                        for (e && e.children && e.children === !0 && (_.state.loaded = !1, _.children = [], _.children_d = []), l[_.id] = _, n = 0, o = _.children.length; o > n; n++) c = m(l[_.children[n]], _.id, r),
                        h = l[c],
                        _.children_d.push(c),
                    ...
                    v = function(e, i, r) {
                        ...
                        if (g.li_attr.id && !g.id && (g.id = "" + g.li_attr.id), g.id || (g.id = s), g.li_attr.id || (g.li_attr.id = g.id), e && "object" == typeof e.a_attr) for (n in e.a_attr) e.a_attr.hasOwnProperty(n) && (g.a_attr[n] = e.a_attr[n]);
                        if (e && e.children && e.children.length) {
                            for (n = 0, h = e.children.length; h > n; n++) _ = v(e.children[n], g.id, r),
                            u = l[_],
                            g.children.push(_),
                    ...
                    if (i.length && i[0].id !== t && i[0].parent !== t) {
                        ...
                        for (g = 0, f = h.children.length; f > g; g++) u = m(l[h.children[g]], r, h.parents.concat()),
                        n.push(u),
                        ...
                        for (g = 0, f = i.length; f > g; g++) u = v(i[g], r, h.parents.concat()),
                        u && (s.push(u), n.push(u), l[u].children_d.length && (n = n.concat(l[u].children_d)));
                        for (h.children = s, h.children_d = n, g = 0, f = h.parents.length; f > g; g++) l[h.parents[g]].children_d = l[h.parents[g]].children_d.concat(n);
                        p = {
                            cnt: c,
                            mod: l,
                            sel: _,
                ...
                o = function(t, i) {
                    if (this._cnt = t.cnt, this._model.data = t.mod, i) {
                        ...
                        if (d.length !== o.length || e.vakata.array_unique(d.concat(o)).length !== d.length) {
                            for (s = 0, n = d.length; n > s; s++) - 1 === e.inArray(d[s], a) && -1 === e.inArray(d[s], o) && (c[d[s]].state.selected = !1);
                            for (s = 0, n = o.length; n > s; s++) - 1 === e.inArray(o[s], d) && (c[o[s]].state.selected = !0)
                        }
                    }
                ...
                if (this.settings.core.worker && window.Blob && window.URL && window.Worker) try {
                    ...
                    !this._data.core.working || s ? (this._data.core.working = !0, n = new window.Worker(this._wrk), n.onmessage = e.proxy(function(e) {
            ...
            _parse_model_from_html: function(i, r, s) {
                ...
                function(i, r) {
                    return r = e.trim(r),
                    r.length ? (o.li_attr[i] = r, "id" === i && (o.id = "" + r), t) : !0
                }), l = i.children("a").first(), l.length && (l = e.vakata.attributes(l, !0), e.each(l,
                function(t, i) {
                    i = e.trim(i),
                    i.length && (o.a_attr[t] = i)
                })), l = i.children("a").first().length ? i.children("a").first().clone() : i.clone(), l.children("ins, i, ul").remove(), l = l.html(), l = e("<div />").html(l), o.text = this.settings.core.force_text ? l.text() : l.html(), l = i.data(), o.data = l ? e.extend(!0, {},
            ...
            _parse_model_from_flat_json: function(e, i, r) {
                ...
                if (h.li_attr.id || (h.li_attr.id = s), e && "object" == typeof e.a_attr) for (d in e.a_attr) e.a_attr.hasOwnProperty(d) && (h.a_attr[d] = e.a_attr[d]);
                for (e && e.children && e.children === !0 && (h.state.loaded = !1, h.children = [], h.children_d = []), n[h.id] = h, d = 0, o = h.children.length; o > d; d++) c = this._parse_model_from_flat_json(n[h.children[d]], h.id, r),
                l = n[c],
                h.children_d.push(c),
            ...
            _parse_model_from_json: function(e, i, r) {
                ...
                if (h.li_attr.id && !h.id && (h.id = "" + h.li_attr.id), h.id || (h.id = s), h.li_attr.id || (h.li_attr.id = h.id), e && "object" == typeof e.a_attr) for (n in e.a_attr) e.a_attr.hasOwnProperty(n) && (h.a_attr[n] = e.a_attr[n]);
                if (e && e.children && e.children.length) {
                    for (n = 0, a = e.children.length; a > n; n++) d = this._parse_model_from_json(e.children[n], h.id, r),
                    o = c[d],
                    h.children.push(d),
            ...
            _redraw: function() {
                ...
                for (r = 0, s = e.length; s > r; r++) i = this.redraw_node(e[r], !0, this._model.force_full_redraw),
                i && this._model.force_full_redraw && t.appendChild(i);
                this._model.force_full_redraw && (t.className = this.get_container_ul()[0].className, t.setAttribute("role", "group"), this.element.empty().append(t)),
            ...
            redraw_node: function(t, i, r, s) {
                ...
                r || (a = t.parent().parent()[0], a === this.element[0] && (a = null), d = t.index()),
                ...
                t.remove();
                    ...
                    if (a = "#" !== n.parent ? e("#" + n.parent.replace(e.jstree.idregex, "\\$&"), this.element)[0] : null, !(null === a || a && f[n.parent].state.opened)) return ! 1;
                    d = e.inArray(n.id, null === a ? f["#"].children: f[n.parent].children)
                }
                t = c.cloneNode(!0),
                u = "jstree-node ";
                for (l in n.li_attr) if (n.li_attr.hasOwnProperty(l)) {
                    if ("id" === l) continue;
                ...
                n.state.loaded && !n.children.length ? u += " jstree-leaf": (u += n.state.opened && n.state.loaded ? " jstree-open": " jstree-closed", t.setAttribute("aria-expanded", n.state.opened && n.state.loaded)),
                ...
                for (h in n.a_attr) if (n.a_attr.hasOwnProperty(h)) {
                ...
                if (u.length && (t.childNodes[1].className = "jstree-anchor " + u), (n.icon && n.icon !== !0 || n.icon === !1) && (n.icon === !1 ? t.childNodes[1].childNodes[0].className += " jstree-themeicon-hidden": -1 === n.icon.indexOf("/") && -1 === n.icon.indexOf(".") ? t.childNodes[1].childNodes[0].className += " " + n.icon + " jstree-themeicon-custom": (t.childNodes[1].childNodes[0].style.backgroundImage = "url(" + n.icon + ")", t.childNodes[1].childNodes[0].style.backgroundPosition = "center center", t.childNodes[1].childNodes[0].style.backgroundSize = "auto", t.childNodes[1].childNodes[0].className += " jstree-themeicon-custom")), this.settings.core.force_text ? t.childNodes[1].appendChild(g.createTextNode(n.text)) : t.childNodes[1].innerHTML += n.text, i && n.children.length && (n.state.opened || s) && n.state.loaded) {
                    for (_ = g.createElement("UL"), _.setAttribute("role", "group"), _.className = "jstree-children", l = 0, h = n.children.length; h > l; l++) _.appendChild(this.redraw_node(n.children[l], i, !0));
                    t.appendChild(_)
                }
                if (o && t.appendChild(o), !r) {
                    for (a || (a = this.element[0]), l = 0, h = a.childNodes.length; h > l; l++) if (a.childNodes[l] && a.childNodes[l].className && -1 !== a.childNodes[l].className.indexOf("jstree-children")) {
                        v = a.childNodes[l];
                        break
                    }
                    v || (v = g.createElement("UL"), v.setAttribute("role", "group"), v.className = "jstree-children", a.appendChild(v)),
                    a = v,
            ...
            open_node: function(i, r, s) {
                ...
                if (s = s === t ? this.settings.core.animation: s, !this.is_closed(i)) return r && r.call(this, i, !1),
                !1;
                if (this.is_loaded(i)) d = this.get_node(i, !0),
                o = this,
                d.length && (i.children.length && !this._firstChild(d.children(".jstree-children")[0]) && (this.redraw_node(i, !0, !1, !0), d = this.get_node(i, !0)), s ? (this.trigger("before_open", {
                    node: i
                }), d.children(".jstree-children").css("display", "none").end().removeClass("jstree-closed").addClass("jstree-open").attr("aria-expanded", !0).children(".jstree-children").stop(!0, !0).slideDown(s,
                function() {
                    this.style.display = "",
            ...
            _open_to: function(t) {
                ...
                var i, r, s = t.parents;
                for (i = 0, r = s.length; r > i; i += 1)"#" !== i && this.open_node(s[i], !1, 0);
            ...
            close_node: function(i, r) {
                ...
                i && "#" !== i.id ? this.is_closed(i) ? !1 : (r = r === t ? this.settings.core.animation: r, a = this, d = this.get_node(i, !0), d.length && (r ? d.children(".jstree-children").attr("style", "display:block !important").end().removeClass("jstree-open").addClass("jstree-closed").attr("aria-expanded", !1).children(".jstree-children").stop(!0, !0).slideUp(r,
                function() {
                    this.style.display = "",
            ...
            toggle_node: function(i) {
                var r, s;
                if (e.isArray(i)) {
                    for (i = i.slice(), r = 0, s = i.length; s > r; r++) this.toggle_node(i[r]);
                    return ! 0
                }
            ...
            open_all: function(e, t, i) {
                ...
                a;
                if (!r.length) {
                    for (s = 0, n = e.children_d.length; n > s; s++) this.is_closed(this._model.data[e.children_d[s]]) && (this._model.data[e.children_d[s]].state.opened = !0);
            ...
            close_all: function(t, i) {
                ...
                var r = "#" === t.id ? this.get_container_ul() : this.get_node(t, !0),
                s = this,
                n,
                a;
                if (!r.length) {
            ...
            enable_node: function(i) {
                var r, s;
                if (e.isArray(i)) {
                    for (i = i.slice(), r = 0, s = i.length; s > r; r++) this.enable_node(i[r]);
                    return ! 0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (i.state.disabled = !1, this.get_node(i, !0).children(".jstree-anchor").removeClass("jstree-disabled").attr("aria-disabled", !1), this.trigger("enable_node", {
                    node: i
                }), t) : !1
            },
            disable_node: function(i) {
                var r, s;
                if (e.isArray(i)) {
                    for (i = i.slice(), r = 0, s = i.length; s > r; r++) this.disable_node(i[r]);
                    return ! 0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (i.state.disabled = !0, this.get_node(i, !0).children(".jstree-anchor").addClass("jstree-disabled").attr("aria-disabled", !0), this.trigger("disable_node", {
                    node: i
                }), t) : !1
            },
            ...
            dehover_node: function(e) {
                return e = this.get_node(e, !0),
                e && e.length && e.children(".jstree-hovered").length ? (e.children(".jstree-anchor").removeClass("jstree-hovered"), this.trigger("dehover_node", {
                    node: this.get_node(e)
                }), t) : !1
            },
            select_node: function(i, r, s, n) {
                var a, d, o, c;
                if (e.isArray(i)) {
                    for (i = i.slice(), d = 0, o = i.length; o > d; d++) this.select_node(i[d], r, s, n);
                    return ! 0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (a = this.get_node(i, !0), i.state.selected || (i.state.selected = !0, this._data.core.selected.push(i.id), s || (a = this._open_to(i)), a && a.length && a.attr("aria-selected", !0).children(".jstree-anchor").addClass("jstree-clicked"), this.trigger("select_node", {
                    node: i,
                    selected: this._data.core.selected,
                    event: n
            ...
            deselect_node: function(i, r, s) {
                var n, a, d;
                if (e.isArray(i)) {
                    for (i = i.slice(), n = 0, a = i.length; a > n; n++) this.deselect_node(i[n], r, s);
                    return ! 0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (d = this.get_node(i, !0), i.state.selected && (i.state.selected = !1, this._data.core.selected = e.vakata.array_remove_item(this._data.core.selected, i.id), d.length && d.attr("aria-selected", !1).children(".jstree-anchor").removeClass("jstree-clicked"), this.trigger("deselect_node", {
                    node: i,
                    selected: this._data.core.selected,
                    event: s
                }), r || this.trigger("changed", {
            ...
            get_top_selected: function(t) {
                ...
                a,
                d;
                for (s = 0, n = i.length; n > s; s++) r[i[s].id] = i[s];
                for (s = 0, n = i.length; n > s; s++) for (a = 0, d = i[s].children_d.length; d > a; a++) r[i[s].children_d[a]] && delete r[i[s].children_d[a]];
                i = [];
            ...
            get_bottom_selected: function(t) {
                ...
                s,
                n;
                for (s = 0, n = i.length; n > s; s++) i[s].children.length || r.push(i[s].id);
            ...
            set_state: function(i, r) {
                if (i) {
                    if (i.core) {
                        var s, n, a, d;
                        if (i.core.open) return e.isArray(i.core.open) ? (s = !0, n = !1, a = this, e.each(i.core.open.concat([]),
                        function(t, d) {
                            n = a.get_node(d),
                            n && (a.is_loaded(d) ? (a.is_closed(d) && a.open_node(d, !1, 0), i && i.core && i.core.open && e.vakata.array_remove_item(i.core.open, d)) : (a.is_loading(d) || a.open_node(d, e.proxy(function(t, s) { ! s && i && i.core && i.core.open && e.vakata.array_remove_item(i.core.open, t.id),
                                this.set_state(i, r)
                            },
                            a), 0), s = !1))
            ...
            refresh: function(t, i) {
                ...
                t || (this.element.html("<ul class='" + r + "' role='group'><" + "li class='jstree-initial-node jstree-loading jstree-leaf jstree-last' role='treeitem' id='j" + this._id + "_loading'><i class='jstree-icon jstree-ocl'></i><" + "a class='jstree-anchor' href='#'><i class='jstree-icon jstree-themeicon-hidden'></i>" + this.get_string("Loading ...") + "</a></li></ul>"), this.element.attr("aria-activedescendant", "j" + this._id + "_loading")),
                this.load_node("#",
                function(t, i) {
                    i && (this.get_container_ul()[0].className = r, this._firstChild(this.get_container_ul()[0]) && this.element.attr("aria-activedescendant", this._firstChild(this.get_container_ul()[0]).id), this.set_state(e.extend(!0, {},
            ...
            set_id: function(t, i) {
                ...
                for (i = "" + i, n[t.parent].children[e.inArray(t.id, n[t.parent].children)] = i, r = 0, s = t.parents.length; s > r; r++) n[t.parents[r]].children_d[e.inArray(t.id, n[t.parents[r]].children_d)] = i;
            ...
            get_json: function(t, i, r) {
                ...
                var s = {
                    ...
                    t.a_attr),
                    state: {},
                    data: i && i.no_data ? !1 : e.extend(!0, {},
                    t.data)
                },
                n,
                a;
                if (i && i.flat ? s.parent = t.parent: s.children = [], !i || !i.no_state) for (n in t.state) t.state.hasOwnProperty(n) && (s.state[n] = t.state[n]);
                if (i && i.no_id && (delete s.id, s.li_attr && s.li_attr.id && delete s.li_attr.id, s.a_attr && s.a_attr.id && delete s.a_attr.id), i && i.flat && "#" !== t.id && r.push(s), !i || !i.no_children) for (n = 0, a = t.children.length; a > n; n++) i && i.flat ? this.get_json(t.children[n], i, r) : s.children.push(this.get_json(t.children[n], i));
                return i && i.flat ? r: "#" === t.id ? s.children: s
            },
            create_node: function(i, r, s, n, a) {
                if (null === i && (i = "#"), i = this.get_node(i), !i) return ! 1;
                if (s = s === t ? "last": s, !("" + s).match(/^(before|after)$/) && !a && !this.is_loaded(i)) return this.load_node(i,
                function() {
                    this.create_node(i, r, s, n, !0)
                });
                r || (r = {
                    text: this.get_string("新部门")
                }),
                r.text === t && (r.text = this.get_string("新部门"));
                var d, o, c, l;
                ...
                for (r = d, d = [], c = 0, l = i.children.length; l > c; c++) d[c >= s ? c + 1 : c] = i.children[c];
                return d[s] = r.id,
                i.children = d,
            ...
            delete_node: function(t) {
                ...
                if (t = this.get_node(t), !t || "#" === t.id) return ! 1;
                if (s = this.get_node(t.parent), n = e.inArray(t.id, s.children), h = !1, !this.check("delete_node", t, s, n)) return this.settings.core.error.call(this, this._data.core.last_error),
                !1;
            ...
            move_node: function(i, r, s, n, a, d) {
                ...
                if (! ("" + s).match(/^(before|after)$/) && !a && !this.is_loaded(r)) return this.load_node(r,
                function() {
                    this.move_node(i, r, s, n, !0)
                });
                if (e.isArray(i)) {
                    for (i = i.slice(), o = 0, c = i.length; c > o; o++) this.move_node(i[o], r, s, n, a, !0) && (r = i[o], s = "after");
                    return this.redraw(),
                    !0
                }
                if (i = i && i.id ? i: this.get_node(i), !i || "#" === i.id) return ! 1;
                if (l = "" + (i.parent || "#"), _ = ("" + s).match(/^(before|after)$/) && "#" !== r.id ? this.get_node(r.parent) : r, u = i.instance ? i.instance: this._model.data[i.id] ? this: e.jstree.reference(i.id), g = !u || !u._id || this._id !== u._id, h = u && u._id && l && u._model.data[l] && u._model.data[l].children ? e.inArray(i.id, u._model.data[l].children) : -1, g) return this.copy_node(i, r, s, n, a) ? (u && u.delete_node(i), !0) : !1;
                ...
                if (s > _.children.length && (s = _.children.length), !this.check("move_node", i, _, s, {
                    core: !0,
                ...
                !1;
                if (i.parent === _.id) {
                    for (f = _.children.concat(), p = e.inArray(i.id, f), -1 !== p && (f = e.vakata.array_remove(f, p), s > p && s--), p = [], m = 0, v = f.length; v > m; m++) p[m >= s ? m + 1 : m] = f[m];
                    p[s] = i.id,
                    _.children = p,
                    ...
                    for (p = i.children_d.concat(), p.push(i.id), m = 0, v = i.parents.length; v > m; m++) {
                        for (f = [], k = u._model.data[i.parents[m]].children_d, j = 0, y = k.length; y > j; j++) - 1 === e.inArray(k[j], p) && f.push(k[j]);
                        u._model.data[i.parents[m]].children_d = f
                    }
                    for (u._model.data[l].children = e.vakata.array_remove_item(u._model.data[l].children, i.id), m = 0, v = _.parents.length; v > m; m++) this._model.data[_.parents[m]].children_d = this._model.data[_.parents[m]].children_d.concat(p);
                    for (f = [], m = 0, v = _.children.length; v > m; m++) f[m >= s ? m + 1 : m] = _.children[m];
                    for (f[s] = i.id, _.children = f, _.children_d.push(i.id), _.children_d = _.children_d.concat(i.children_d), i.parent = _.id, p = _.parents.concat(), p.unshift(_.id), k = i.parents.length, i.parents = p, p = p.concat(), m = 0, v = i.children_d.length; v > m; m++) this._model.data[i.children_d[m]].parents = this._model.data[i.children_d[m]].parents.slice(0, -1 * k),
                    Array.prototype.push.apply(this._model.data[i.children_d[m]].parents, p); ("#" === l || "#" === _.id) && (this._model.force_full_redraw = !0),
                    this._model.force_full_redraw || (this._node_changed(l), this._node_changed(_.id)),
                    d || this.redraw()
                }
            ...
            copy_node: function(i, r, s, n, a, d) {
                ...
                if (e.isArray(i)) {
                    for (i = i.slice(), o = 0, c = i.length; c > o; o++) h = this.copy_node(i[o], r, s, n, a, !0),
                    h && (r = h, s = "after");
                    return this.redraw(),
                    !0
                }
                ...
                if (s > p.children.length && (s = p.children.length), !this.check("copy_node", i, p, s, {
                    core: !0,
                ...
                if (g.id === !0 && delete g.id, g = this._parse_model_from_json(g, p.id, p.parents.concat()), !g) return ! 1;
                for (h = this.get_node(g), i && i.state && i.state.loaded === !1 && (h.state.loaded = !1), l = [], l.push(g), l = l.concat(h.children_d), this.trigger("model", {
                    nodes: l,
                    parent: p.id
                }), _ = 0, u = p.parents.length; u > _; _++) this._model.data[p.parents[_]].children_d = this._model.data[p.parents[_]].children_d.concat(l);
                for (l = [], _ = 0, u = p.children.length; u > _; _++) l[_ >= s ? _ + 1 : _] = p.children[_];
                return l[s] = h.id,
                p.children = l,
            ...
            cut: function(i) {
                ...
                return a.length ? (r = a, n = this, s = "move_node", this.trigger("cut", {
                    node: i
                }), t) : !1
            },
            copy: function(i) {
                ...
                for (o = 0, c = i.length; c > o; o++) d = this.get_node(i[o]),
                d && d.id && "#" !== d.id && a.push(d);
                return a.length ? (r = a, n = this, s = "copy_node", this.trigger("copy", {
                    node: i
                }), t) : !1
            },
            get_buffer: function() {
            ...
            set_icon: function(t, i) {
                var r, s, n, a;
                if (e.isArray(t)) {
                    for (t = t.slice(), r = 0, s = t.length; s > r; r++) this.set_icon(t[r], i);
                    return ! 0
                }
                return t = this.get_node(t),
            ...
            show_icon: function(t) {
                ...
                return t = this.get_node(t),
                t && "#" !== t ? (s = this.get_node(t, !0), t.icon = s.length ? s.children(".jstree-anchor").children(".jstree-themeicon").attr("rel") : !0, t.icon || (t.icon = !0), s.children(".jstree-anchor").children(".jstree-themeicon").removeClass("jstree-themeicon-hidden"), !0) : !1
            }
        },
        e.vakata = {},
        e.vakata.attributes = function(t, i) {
            ...
            function(t, s) { - 1 === e.inArray(s.name.toLowerCase(), ["style", "contenteditable", "hasfocus", "tabindex"]) && null !== s.value && "" !== e.trim(s.value) && (i ? r[s.name] = s.value: r.push(s.name))
            }),
            r
        },
        ...
        e.jstree.plugins.checkbox = function(i, r) {
            this.bind = function() {
                ...
                this.settings.checkbox.tie_selection || this.element.on("model.jstree", e.proxy(function(e, t) {
                    ...
                    n,
                    a;
                    for (n = 0, a = s.length; a > n; n++) i[s[n]].state.checked = i[s[n]].original && i[s[n]].original.state && i[s[n]].original.state.checked,
                ...
                ( - 1 !== this.settings.checkbox.cascade.indexOf("up") || -1 !== this.settings.checkbox.cascade.indexOf("down")) && this.element.on("model.jstree", e.proxy(function(t, i) {
                    ...
                    if ( - 1 !== u.indexOf("down")) if (s.state[g ? "selected": "checked"]) {
                        for (o = 0, c = n.length; c > o; o++) r[n[o]].state[g ? "selected": "checked"] = !0;
                        this._data[g ? "core": "checkbox"].selected = this._data[g ? "core": "checkbox"].selected.concat(n)
                    } else for (o = 0, c = n.length; c > o; o++) if (r[n[o]].state[g ? "selected": "checked"]) {
                        for (l = 0, h = r[n[o]].children_d.length; h > l; l++) r[r[n[o]].children_d[l]].state[g ? "selected": "checked"] = !0;
                        this._data[g ? "core": "checkbox"].selected = this._data[g ? "core": "checkbox"].selected.concat(r[n[o]].children_d)
                    }
                    if ( - 1 !== u.indexOf("up")) {
                        for (o = 0, c = s.children_d.length; c > o; o++) r[s.children_d[o]].children.length || a.push(r[s.children_d[o]].parent);
                        for (a = e.vakata.array_unique(a), l = 0, h = a.length; h > l; l++) {
                            s = r[a[l]];
                            while (s && "#" !== s.id) {
                                for (d = 0, o = 0, c = s.children.length; c > o; o++) d += r[s.children[o]].state[g ? "selected": "checked"];
                                if (d !== c) break;
                ...
                this)).on(this.settings.checkbox.tie_selection ? "select_node.jstree": "check_node.jstree", e.proxy(function(t, i) {
                    ...
                    if ( - 1 !== h.indexOf("down")) for (this._data[_ ? "core": "checkbox"].selected = e.vakata.array_unique(this._data[_ ? "core": "checkbox"].selected.concat(r.children_d)), d = 0, o = r.children_d.length; o > d; d++) l = s[r.children_d[d]],
                    ...
                    if ( - 1 !== h.indexOf("up")) while (n && "#" !== n.id) {
                        for (c = 0, d = 0, o = n.children.length; o > d; d++) c += s[n.children[d]].state[_ ? "selected": "checked"];
                        if (c !== o) break;
                ...
                this)).on(this.settings.checkbox.tie_selection ? "deselect_all.jstree": "uncheck_all.jstree", e.proxy(function(e, t) {
                    ...
                    n,
                    a;
                    for (s = 0, n = i.children_d.length; n > s; s++) a = r[i.children_d[s]],
                ...
                this)).on(this.settings.checkbox.tie_selection ? "deselect_node.jstree": "uncheck_node.jstree", e.proxy(function(t, i) {
                    ...
                    if (r && r.original && r.original.state && r.original.state.undetermined && (r.original.state.undetermined = !1), -1 !== o.indexOf("down")) for (n = 0, a = r.children_d.length; a > n; n++) d = this._model.data[r.children_d[n]],
                    d.state[c ? "selected": "checked"] = !1,
                    d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1);
                    if ( - 1 !== o.indexOf("up")) for (n = 0, a = r.parents.length; a > n; n++) d = this._model.data[r.parents[n]],
                    d.state[c ? "selected": "checked"] = !1,
                    d && d.original && d.original.state && d.original.state.undetermined && (d.original.state.undetermined = !1),
                    ...
                    for (d = [], n = 0, a = this._data[c ? "core": "checkbox"].selected.length; a > n; n++) - 1 !== o.indexOf("down") && -1 !== e.inArray(this._data[c ? "core": "checkbox"].selected[n], r.children_d) || -1 !== o.indexOf("up") && -1 !== e.inArray(this._data[c ? "core": "checkbox"].selected[n], r.parents) || d.push(this._data[c ? "core": "checkbox"].selected[n]);
                ...
                -1 !== this.settings.checkbox.cascade.indexOf("up") && this.element.on("delete_node.jstree", e.proxy(function(e, t) {
                    ...
                    while (i && "#" !== i.id) {
                        for (a = 0, s = 0, n = i.children.length; n > s; s++) a += r[i.children[s]].state[o ? "selected": "checked"];
                        if (a !== n) break;
                ...
                this)).on("move_node.jstree", e.proxy(function(t, i) {
                    ...
                    while (d && "#" !== d.id) {
                        for (o = 0, c = 0, l = d.children.length; l > c; c++) o += a[d.children[c]].state[_ ? "selected": "checked"];
                        if (o === l) d.state[_ ? "selected": "checked"] || (d.state[_ ? "selected": "checked"] = !0, this._data[_ ? "core": "checkbox"].selected.push(d.id), h = this.get_node(d, !0), h && h.length && h.attr("aria-selected", !0).children(".jstree-anchor").addClass(_ ? "jstree-clicked": "jstree-checked"));
                        else {
            ...
            this._undetermined = function() {
                var t, i, r = this._model.data,
                s = this.settings.checkbox.tie_selection,
                n = this._data[s ? "core": "checkbox"].selected,
                a = [],
                d = this;
                for (t = 0, i = n.length; i > t; t++) r[n[t]] && r[n[t]].parents && (a = a.concat(r[n[t]].parents));
                for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function() {
                    var e = d.get_node(this),
                    s;
                    if (e.state.loaded) for (t = 0, i = e.children_d.length; i > t; t++) s = r[e.children_d[t]],
                    !s.state.loaded && s.original && s.original.state && s.original.state.undetermined && s.original.state.undetermined === !0 && (a.push(s.id), a = a.concat(s.parents));
                ...
                }), a = e.vakata.array_unique(a), a = e.vakata.array_remove_item(a, "#"), this.element.find(".jstree-undetermined").removeClass("jstree-undetermined"), t = 0, i = a.length; i > t; t++) r[a[t]].state[s ? "selected": "checked"] || (n = this.get_node(a[t], !0), n && n.length && n.children(".jstree-anchor").children(".jstree-checkbox").addClass("jstree-undetermined"))
            },
            this.redraw_node = function(t, i, s, n) {
                if (t = r.redraw_node.apply(this, arguments)) {
                    var a, d, o = null;
                    for (a = 0, d = t.childNodes.length; d > a; a++) if (t.childNodes[a] && t.childNodes[a].className && -1 !== t.childNodes[a].className.indexOf("jstree-anchor")) {
                        o = t.childNodes[a];
                        break
                    }
                ...
                return s || -1 === this.settings.checkbox.cascade.indexOf("undetermined") || (this._data.checkbox.uto && clearTimeout(this._data.checkbox.uto), this._data.checkbox.uto = setTimeout(e.proxy(this._undetermined, this), 50)),
                t
            },
            ...
            this.is_undetermined = function(t) {
                ...
                r, s, n = this.settings.checkbox.tie_selection,
            ...
            this.activate_node = function(i, s) {
                ...
                this.settings.checkbox.tie_selection || !this.settings.checkbox.whole_node && !e(s.target).hasClass("jstree-checkbox") ? r.activate_node.call(this, i, s) : (this.is_checked(i) ? this.uncheck_node(i, s) : this.check_node(i, s), this.trigger("activate_node", {
                    node: this.get_node(i)
                }), t)
            },
            this.check_node = function(i, r) {
                if (this.settings.checkbox.tie_selection) return this.select_node(i, !1, !0, r);
                var s, n, a, d;
                if (e.isArray(i)) {
                    for (i = i.slice(), n = 0, a = i.length; a > n; n++) this.check_node(i[n], r);
                    return ! 0
                }
                return i = this.get_node(i),
                i && "#" !== i.id ? (s = this.get_node(i, !0), i.state.checked || (i.state.checked = !0, this._data.checkbox.selected.push(i.id), s && s.length && s.children(".jstree-anchor").addClass("jstree-checked"), this.trigger("check_node", {
                    node: i,
            ...
            this.uncheck_node = function(i, r) {
                if (this.settings.checkbox.tie_selection) return this.deselect_node(i, !1, r);
                var s, n, a;
                if (e.isArray(i)) {
                    for (i = i.slice(), s = 0, n = i.length; n > s; s++) this.uncheck_node(i[s], r);
                    return ! 0
                }
                return i = this.get_node(i),
        ...
        e.jstree.plugins.contextmenu = function(i, r) {
            ...
            this.show_contextmenu = function(i, r, s, n) {
                ...
                c = !1,
                l = !1; (a.show_at_node || r === t || s === t) && (c = o.offset(), r = c.left, s = c.top + this._data.core.li_height),
        ...
        function(e) {
            ...
            e.vakata.context = {
                ...
                _parse: function(i, s) {
                    ...
                    e.each(i,
                    function(i, s) {
                        return s ? (r.items.push(s), !a && s.separator_before && (n += "<li class='vakata-context-separator'><a href='#' " + (e.vakata.context.settings.icons ? "": 'style="margin-left:0px;"') + ">&#160;<" + "/a><" + "/li>"), a = !1, n += "<li class='" + (s._class || "") + (s._disabled === !0 || e.isFunction(s._disabled) && s._disabled({
                            item: s,
                            reference: r.reference,
                            element: r.element
                        }) ? " vakata-contextmenu-disabled ": "") + "' " + (s.shortcut ? " data-shortcut='" + s.shortcut + "' ": "") + ">", n += "<a href='#' rel='" + (r.items.length - 1) + "'>", e.vakata.context.settings.icons && (n += "<i ", s.icon && (n += -1 !== s.icon.indexOf("/") || -1 !== s.icon.indexOf(".") ? " style='background:url(\"" + s.icon + "\") center center no-repeat' ": " class='" + s.icon + "' "), n += "></i><span class='vakata-contextmenu-sep'>&#160;</span>"), n += (e.isFunction(s.label) ? s.label({
                            item: i,
                            reference: r.reference,
                            element: r.element
                        }) : s.label) + (s.shortcut ? ' <span class="vakata-contextmenu-shortcut vakata-contextmenu-shortcut-' + s.shortcut + '">' + (s.shortcut_label || "") + "</span>": "") + "<" + "/a>", s.submenu && (d = e.vakata.context._parse(s.submenu, !0), d && (n += d)), n += "</li>", s.separator_after && (n += "<li class='vakata-context-separator'><a href='#' " + (e.vakata.context.settings.icons ? "": 'style="margin-left:0px;"') + ">&#160;<" + "/a><" + "/li>", a = !0), t) : !0
                    }),
                    n = n.replace(/<li class\='vakata-context-separator'\><\/li\>$/, ""),
                    s && (n += "</ul>"),
                    s || (r.html = n, e.vakata.context._trigger("parse")),
                    n.length > 10 ? n: !1
                },
                ...
                show: function(t, s, n) {
                    ...
                    case ! s && !!t: r.reference = t,
                        ...
                        r.position_y = a.top;
                        break;
                    case !! s && !t: r.position_x = s.x,
                        r.position_y = s.y
                    }
                    t && !n && e(t).data("vakata_contextmenu") && (n = e(t).data("vakata_contextmenu")),
                    e.vakata.context._parse(n) && r.element.html(r.html),
                    r.items.length && (r.element.appendTo("body"), d = r.element, o = r.position_x, c = r.position_y, l = d.width(), h = d.height(), _ = e(window).width() + e(window).scrollLeft(), u = e(window).height() + e(window).scrollTop(), i && (o -= d.outerWidth(), e(window).scrollLeft() + 20 > o && (o = e(window).scrollLeft() + 20)), o + l + 20 > _ && (o = _ - (l + 20)), c + h + 20 > u && (c = u - (h + 20)), r.element.css({
                        left: o,
                        top: c
                    }).show().find("a").first().focus().parent().addClass("vakata-context-hover"), r.is_visible = !0, e.vakata.context._trigger("show"))
                },
                hide: function() {
            ...
            e(function() {
                ...
                function(i) {
                    ...
                    e.contains(this, i.relatedTarget) || (t && clearTimeout(t), r.element.find(".vakata-context-hover").removeClass("vakata-context-hover").end(), e(this).siblings().find("ul").hide().end().end().parentsUntil(".vakata-context", "li").addBack().addClass("vakata-context-hover"), e.vakata.context._show_submenu(this))
                }).on("mouseleave", "li",
                function(t) {
        ...
        e.jstree.plugins.dnd = function(i, r) {
            this.bind = function() {
                ...
                this.element.on("mousedown.jstree touchstart.jstree", ".jstree-anchor", e.proxy(function(i) {
                    ...
                    return r && r.id && "#" !== r.id && (1 === i.which || "touchstart" === i.type) && (this.settings.dnd.is_draggable === !0 || e.isFunction(this.settings.dnd.is_draggable) && this.settings.dnd.is_draggable.call(this, s > 1 ? this.get_selected(!0) : [r])) ? (this.element.trigger("mousedown.jstree"), e.vakata.dnd.start(i, {
                        jstree: !0,
                        origin: this,
                    ...
                    if (o && o._data && o._data.dnd) if (n.attr("class", "jstree-" + o.get_theme() + (o.settings.core.themes.responsive ? " jstree-dnd-responsive": "")), d.helper.children().attr("class", "jstree-" + o.get_theme() + " jstree-" + o.get_theme() + "-" + o.get_theme_variant() + " " + (o.settings.core.themes.responsive ? " jstree-dnd-responsive": "")).find(".jstree-copy").first()[d.data.origin && (d.data.origin.settings.dnd.always_copy || d.data.origin.settings.dnd.copy && (d.event.metaKey || d.event.ctrlKey)) ? "show": "hide"](), d.event.target !== o.element[0] && d.event.target !== o.get_container_ul()[0] || 0 !== o.get_container_ul().children().length) {
                        ...
                        function(a, h) {
                            ...
                            n.css({
                                left: _ + "px",
                                top: u + "px"
                            }).show(), d.helper.find(".jstree-icon").first().removeClass("jstree-er").addClass("jstree-ok"), r = {},
                            m = !0, !1) : t
                        }), m === !0)) return
                    } else {
                ...
                drag: function(r) {
                    if ("touchmove" === r.type && r.originalEvent && r.originalEvent.changedTouches && r.originalEvent.changedTouches[0] && (r.pageX = r.originalEvent.changedTouches[0].pageX, r.pageY = r.originalEvent.changedTouches[0].pageY, r.target = document.elementFromPoint(r.originalEvent.changedTouches[0].pageX - window.pageXOffset, r.originalEvent.changedTouches[0].pageY - window.pageYOffset)), i.is_down) {
                        ...
                        e(e(r.target).parentsUntil("body").addBack().get().reverse()).filter(function() {
                            ...
                            var s = e(this),
                            n = s.offset();
                            return this.scrollHeight > this.offsetHeight && (n.top + s.height() - r.pageY < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1), r.pageY - n.top < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1)),
                            this.scrollWidth > this.offsetWidth && (n.left + s.width() - r.pageX < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1), r.pageX - n.left < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1)),
                            i.scroll_t || i.scroll_l ? (i.scroll_e = e(this), !1) : t
                        }),
                        i.scroll_e || (s = e(document), n = e(window), a = s.height(), d = n.height(), o = s.width(), c = n.width(), l = s.scrollTop(), h = s.scrollLeft(), a > d && r.pageY - l < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = -1), a > d && d - (r.pageY - l) < e.vakata.dnd.settings.scroll_proximity && (i.scroll_t = 1), o > c && r.pageX - h < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = -1), o > c && c - (r.pageX - h) < e.vakata.dnd.settings.scroll_proximity && (i.scroll_l = 1), (i.scroll_t || i.scroll_l) && (i.scroll_e = s)),
                        i.scroll_e && e.vakata.dnd._scroll(!0),
                        i.helper && (_ = parseInt(r.pageY + e.vakata.dnd.settings.helper_top, 10), u = parseInt(r.pageX + e.vakata.dnd.settings.helper_left, 10), a && _ + 25 > a && (_ = a - 50), o && u + i.helper_w > o && (u = o - (i.helper_w + 2)), i.helper.css({
                            left: u + "px",
                            top: _ + "px"
                        })),
        ...
        e.jstree.plugins.search = function(i, r) {
            this.bind = function() {
                ...
                this.element.on("before_open.jstree", e.proxy(function(t, i) {
                    var r, s, n, a = this._data.search.res,
                    d = [],
                    o = e();
            ...
            this.search = function(i, r, s) {
                ...
                r || a === !1 ? (this._data.search.str = i, this._data.search.dom = e(), this._data.search.res = [], this._data.search.opn = [], this._data.search.som = s, d = new e.vakata.search(i, !0, {
                ...
                }), o.length && (c = e.vakata.array_unique(c), this._search_open(c), this._data.search.dom = e(this.element[0].querySelectorAll("#" + e.map(o,
                function(t) {
                    return - 1 !== "0123456789".indexOf(t[0]) ? "\\3" + t[0] + " " + t.substr(1).replace(e.jstree.idregex, "\\$&") : t.replace(e.jstree.idregex, "\\$&")
                }).join(", #"))), this._data.search.res = o, this._data.search.dom.children(".jstree-anchor").addClass("jstree-search")), this.trigger("search", {
                ...
                this)) : (a = e.extend({},
                a), a.data || (a.data = {}), a.data.str = i, e.ajax(a).fail(e.proxy(function() {
                    this._data.core.last_error = {
                        error: "ajax",
                        plugin: "search",
                        id: "search_01",
            ...
            this._search_open = function(t) {
                ...
                function(r, s) {
                    ...
                    s && s.length && i.is_closed(s) && (i._data.search.opn.push(s[0].id), i.open_node(s,
                    function() {
                        i._search_open(t)
                    },
                    0))
            ...
            e.vakata.search = function(e, t, i) {
                ...
                l = function(t) {
                    ...
                    for ( - 1 !== u && (_ = Math.min(c(0, u), _), u = t.lastIndexOf(e, r + a), -1 !== u && (_ = Math.min(c(0, u), _))), u = -1, s = 0; a > s; s++) {
                        g = 0,
                        f = p;
                        while (f > g) _ >= c(s, r + f) ? g = f: p = f,
                        f = Math.floor((p - g) / 2 + g);
                        for (p = f, v = Math.max(1, r - f + 1), j = Math.min(r + f, h) + a, y = Array(j + 2), y[j + 1] = (1 << s) - 1, l = j; l >= v; l--) if (k = o[t.charAt(l - 1)], y[l] = 0 === s ? (1 | y[l + 1] << 1) & k: (1 | y[l + 1] << 1) & k | (1 | (m[l + 1] | m[l]) << 1) | m[l + 1], y[l] & d && (x = c(s, l - 1), _ >= x)) {
        ...
        e.jstree.plugins.types = function(i, r) {
            this.init = function(e, i) {
                var s, n;
                if (i && i.types && i.types["default"]) for (s in i.types) if ("default" !== s && "#" !== s && i.types.hasOwnProperty(s)) for (n in i.types["default"]) i.types["default"].hasOwnProperty(n) && i.types[s][n] === t && (i.types[s][n] = i.types["default"][n]);
            ...
            this.get_json = function(t, i, s) {
                ...
                i && i.no_id && (delete c[n].id, c[n].li_attr && c[n].li_attr.id && delete c[n].li_attr.id, c[n].a_attr && c[n].a_attr.id && delete c[n].a_attr.id);
            ...
            this._delete_ids = function(t) {
                if (e.isArray(t)) {
                    for (var i = 0,
                    r = t.length; r > i; i++) t[i] = this._delete_ids(t[i]);
                    return t
                }
                return delete t.id,
            ...
            this.check = function(i, s, n, a, d) {
                if (r.check.call(this, i, s, n, a, d) === !1) return ! 1;
                s = s && s.id ? s: this.get_node(s),
                n = n && n.id ? n: this.get_node(n);
                var o = s && s.id ? e.jstree.reference(s.id) : null,
                c,
                l,
                h,
                _;
                ...
                case "copy_node":
                    if ("move_node" !== i || -1 === e.inArray(s.id, n.children)) {
                        ...
                        if (o && s.children_d && s.parents) {
                            for (l = 0, h = 0, _ = s.children_d.length; _ > h; h++) l = Math.max(l, o[s.children_d[h]].parents.length);
            ...
            this.set_type = function(i, r) {
                ...
                i = this.get_node(i),
                s[r] && i ? (d = i.type, o = this.get_icon(i), i.type = r, (o === !0 || s[d] && s[d].icon !== t && o === s[d].icon) && this.set_icon(i, s[r].icon !== t ? s[r].icon: !0), !0) : !1
            }
        },
        ...
        e.jstree.plugins.unique = function(i, r) {
            ...
            this.create_node = function(i, s, n, a, d) {
                if (!s || s.text === t) {
                    if (null === i && (i = "#"), i = this.get_node(i), !i) return r.create_node.call(this, i, s, n, a, d);
                    if (n = n === t ? "last": n, !("" + n).match(/^(before|after)$/) && !d && !this.is_loaded(i)) return r.create_node.call(this, i, s, n, a, d);
                    s || (s = {});
                    var o, c, l, h, _, u = this._model.data,
                    g = this.settings.unique.case_sensitive,
                    f = this.settings.unique.duplicate;
                    for (c = o = this.get_string("新部门"), l = [], h = 0, _ = i.children.length; _ > h; h++) l.push(g ? u[i.children[h]].text: u[i.children[h]].text.toLowerCase());
                    h = 1;
        ...
        e.jstree.plugins.wholerow = function(t, i) {
            this.bind = function() {
                ...
                this)).on("changed.jstree", e.proxy(function(e, t) {
                    ...
                    var i = !1,
                    r, s;
                    for (r = 0, s = t.selected.length; s > r; r++) i = this.get_node(t.selected[r], !0),
