...
defined('CONF_PATH')    or define('CONF_PATH',      APP_PATH.'Data/Conf/'); // 项目配置目录
defined('LANG_PATH')    or define('LANG_PATH',      APP_PATH.'Lanrain/Lang/'); // 项目语言包目录
...
function load_runtime_file() {
    ...
    // 加载系统类库别名定义
    alias_import(include THINK_PATH.'Data/Conf/alias.php');
...
function build_runtime_cache($append='') {
    ...
    $alias      = include THINK_PATH.'Data/Conf/alias.php';
