...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Home,Qyapp,Yi,Weiyi,Agent',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    'DEFAULT_GROUP'         => 'Weiyi',  // 默认分组
    'DEFAULT_MODULE'        => 'Weiyi', // 默认模块名称
    ...
    'LOG_DEST'              => '', // 日志记录目标
    'LOG_EXTRA'             => '', // 日志记录额外信息
    'c'             => 'EMERG,ALERT,CRIT,ERR',// 允许记录的日志级别
