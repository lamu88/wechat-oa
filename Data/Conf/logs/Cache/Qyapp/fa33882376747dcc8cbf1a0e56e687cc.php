        ...
        <section class="panel panel-default panel-max-width">
            <div class="panel-body">
                <ul class="list-unstyled list-step clearfix">
                    ...
                    <li class="app-step-line"></li>
                    <li class="app-step app-step-br active"><strong>开启自定义菜<br>单和地理位置</strong><span>5</span></li>
                    <li class="app-step-line"></li>
                ...
                <form class="form-horizontal form-validate" method="post" action="" target="_self" novalidate="novalidate">
                    <div class="alert alert-info">开启自定义菜单和上报用户地理位置，如下图</div>
                    <p><img style="max-width:980px" src="./Tpl/Qyapp/Install/Install/step5-1.jpg"></p>
                    <p><img style="max-width:980px" src="./Tpl/Qyapp/Install/Install/step5-2.jpg"></p>
