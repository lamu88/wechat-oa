...
$(document).ready(function(){ 
	$(".sent_file").click(function() {
		...
		var subdata='type=file&fileid='+fileid+'&agentid=<?php echo $_GET['id'];?>&departid='+departid;
		alert(subdata);
		$.ajax({
				type: "post",  
  ...
  <section class="hbox stretch" ng-controller="MsgController" style="height:1000px;"> 
   <aside class="bg-white"> 
    <header class="header bg-white b-b b-light"> 
     <p> 群发新消息 <small><?php echo ($appinfo["name"]); ?></small> </p> 
     <div class="thumb-sm"> 
    ...
    <section class="vbox "> 
     <header class="header bg-light"> 
				...
				<li  class="nav_select active"><a href="<?php echo U('file_post',array('id'=>$_GET['id']));?>" target="_self">文件</a></li>
			</ul> 
     </header> 
      ...
      <section class="scrollable message_block" > 
       ...
       <div class="tab-pane  wrapper  video_items js_file_container file" id="file_container" style="height:390px;"> 
        ...
        <ul class="js_items clearfix" style="position: relative; height: 0px; margin-left:0px;" > 
         <?php if($list == ''): ?><div class="empty_placeholder_wrap empty_placeholder_file"> 
           <span class="icon_empty_placeholder"></span> 
           <p class="empty_placeholder_text">没有文件素材</p> 
          </div><?php endif; ?> 
         <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><li class="tile" fileid="<?php echo ($li["id"]); ?>" title="<?php echo ($li["title"]); ?>" style="list-style:none;padding-left:0px;  "> 
           <div class=" video_unit select_<?php echo ($li["id"]); ?> "  style="width:140px; margin-bottom:2px;">
            <p class="video_title"><?php echo ($li["title"]); ?></p> 
            <a class="video_image " style="border: 0px;" href="javascript:;" target="_self"> 
              <img src="
			  <?php if($li['type'] == 'txt'): ?>./Tpl/Qyapp/Msg/img/txt.png
			   <?php elseif($li['type'] == 'zip'): ?>./Tpl/Qyapp/Msg/img/zip.png
			    <?php elseif($li['type'] == 'doc'): ?>./Tpl/Qyapp/Msg/img/document.png
				 <?php elseif($li['type'] == 'pdf'): ?>./Tpl/Qyapp/Msg/img/pdf.png
				  <?php else: ?>./Tpl/Qyapp/Msg/img/file.png<?php endif; ?>
			  " />  </a> 
        ...
        <div class="mc_avatar_wrap"> 
         <img src="<?php echo ($appinfo["logo"]); ?>" class="border_alpha" /> 
			...
			<div class="  " style="width:250px; float:right; margin-right:70px;">
              <img src="./Tpl/Qyapp/Msg/img/file.png" width=70px height=70px />  <font class='title'><?php echo ($li["title"]); ?></font>
           </div>
