...
<div id="addapps" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	</div> 
<div id="addapplist" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	</div> 
<section class="vbox">
   ...
   <section class="scrollable wrapper w-f" style="padding:0px;">
        <section class="panel panel-default ">
		    ...
		    <?php if($jichu): ?><div class="row m-l-none m-r-none bg-light lter portlet">	
				<p>
				<?php echo ($jichu["head"]); ?>
		    ...
		    <?php if($sanji): ?><div class="row m-l-none m-r-none bg-light lter portlet">	
				<p>
				<?php echo ($sanji["head"]); ?>
		    ...
		    <?php if($hangye): ?><div class="row m-l-none m-r-none bg-light lter portlet">	
				<p>
		    ...
		    <?php if($shangwu): ?><div class="row m-l-none m-r-none bg-light lter portlet">	
				<p>
		    ...
		    <?php if($crm): ?><div class="row m-l-none m-r-none bg-light lter portlet">	
				<p>
				<?php echo ($crm["head"]); ?>
		    ...
		    <?php if($hudong): ?><div class="row m-l-none m-r-none bg-light lter portlet">	
				<p>
...
<script type="text/javascript">  
	function addapps(id,status){
		var id = id;
		var status = status;
		$('#addapps').load("<?php echo U('Appslist/choose_type',array('token'=>$_GET['token']));?>&appid="+id+"&status="+status, function(){
			 $('#addapps').modal();
		});		   
	}
	function addapplist(){
		//var id = id;
		//var status = status;&appid="+id+"&status="+status
		$('#addapplist').load("<?php echo U('Appslist/addapplist',array('token'=>$_GET['token']));?>", function(){
			 $('#addapplist').modal();
		});		   
	}
</script> 		
