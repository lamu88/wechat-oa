                    ...
                    <form class="talbe-search" method="get" target="_self" action="">
                        <div class="row m-t-sm">
                            <div class="col-sm-8 m-b-xs">
                               <!-- <a href="javascript:;" class="btn btn-default btn-sm" data-toggle="modal" data-target="#js_type_modal"><i class="fa fa-plus"></i>增加</a> -->
...
<form class="form-horizontal form-validate form-modal" target="_self" action="<?php echo U('Applyflow/add');?>" method="post"> 
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				$('#info').load("index.php?g=Qyapp&m=Applyflow&a=detailsInfo&id="+userId);
				$('.entity-panel').removeClass('hd');
