                    ...
                    <form class="talbe-search" method="get" target="_self"  action="">
                        <div class="row m-t-sm">
                            <div class="col-sm-8 m-b-xs">
                                ...
                                <div class="btn-group">
                                     <a href="<?php echo U('Hiring/resume',array('mid'=>$_GET['mid']));?>" target="_self" class="btn btn-sm btn-default  <?php if($status == 1): ?>active<?php endif; ?>" title="全部">
                                        全部
                                    </a>
                                    <a href="<?php echo U('Hiring/resume',array('mid'=>$_GET['mid'],'is_read'=>2));?>" target="_self" class="btn btn-sm btn-default  <?php if($is_read == 2): ?>active<?php endif; ?>" title="未读">
                                        未读
                                    </a>
                                    <a href="<?php echo U('Hiring/resume',array('mid'=>$_GET['mid'],'is_read'=>1));?>" target="_self" class="btn btn-sm btn-default  <?php if($is_read == 1): ?>active<?php endif; ?>" title="已读">
                                        已读
                                    </a>
                                    <a href="<?php echo U('Hiring/resume',array('mid'=>$_GET['mid'],'is_collect'=>1));?>" target="_self" class="btn btn-sm btn-default  <?php if($is_collect == 1): ?>active<?php endif; ?>" title="收藏">
                                        收 藏
                                    </a>
                                    <a href="<?php echo U('Hiring/resume',array('mid'=>$_GET['mid'],'is_employed'=>1));?>" target="_self" class="btn btn-sm btn-default  <?php if($is_employed == 1): ?>active<?php endif; ?>" title="录用">
                                        录用
                                    </a>
                            ...
                            <table class="table table-hover m-b-none entity-view">
                                <thead>
                                    <tr>
                                        ...
                                        <th>联系电话</th>
                                        <th>推荐人</th>
                                        <th class="th-sortable" data-sort-name="hiring_resume_delivery_time">投递时间</th>
                                        <th></th>
                                    </tr>
                                </thead>
								<tbody id="mytable">
                ...
                <footer class="footer bg-white b-t">
                    <div class="row text-center-xs">
                        ...
                        <div class="col-md-6 col-sm-12 text-right text-center-xs">
                            <ul class="pagination pagination-sm m-t-sm m-b-none" data-pages-total="0" data-page-current="1"><?php echo ($page); ?></ul>
                        </div>
                    </div>
                </footer>
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				$('#info').load("index.php?g=Qyapp&m=Hiring&a=resumeInfo&mid=<?php echo $_GET['mid'];?>&id="+userId);
				$('.entity-panel').removeClass('hd');
