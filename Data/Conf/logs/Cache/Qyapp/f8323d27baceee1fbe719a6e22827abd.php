                        ...
                        <div class="col-sm-4 m-b-xs">							
                                <div class="input-group">
                                    ...
                                    <div class="input-group js_show_date js_show_date_0 " id="select_4" >
										...
										<input type="text" class="form-control input-sm" style="display:none; width:230px;" name="tel" id="tel" value="<?php echo ($tel); ?>" placeholder="电话必须为11位手机号码"/>	
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover m-b-none entity-view"> 
                            ...
                            <tr>
                                ...
                                <th class="th-sortable">电话</th>								
                                <th class="th-sortable">主题</th>
								<th class="th-sortable">内容</th>
                                <th class="th-sortable">留言时间</th>
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				$('#info').load("index.php?g=Qyapp&m=Borrow_books&a=message_info&mid=<?php echo $_GET['mid'];?>&id="+userId);
				$('.entity-panel').removeClass('hd');
