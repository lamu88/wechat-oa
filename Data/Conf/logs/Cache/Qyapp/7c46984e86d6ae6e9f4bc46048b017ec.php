...
$(function(){
  $(".save_c").click(function() {
	...
	$.ajax({
			type: "post",  
			url:"<?php echo U('Hiring/head',array('mid'=>$_GET['mid']));?>",
			dataType:'json',
			data:'imgurl='+imgurl,
                ...
                <section class="scrollable  wrapper">
                    <section class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-sm-12">
                                <div class="col-sm-2">
                                    <img class="thumb_img" src="<?php if($infos['headpic'] != ''): echo ($infos["headpic"]); else: ?>./assets/images/avatar1.jpg<?php endif; ?>" style="max-height: 100px;" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <p class="form-control-static"><?php echo ($infos["territory"]); ?></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">规模</label>
                                    <div class="col-sm-10">
                                       <p class="form-control-static"><?php echo ($infos["size"]); ?></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">地点</label>
                                    <div class="col-sm-10">
                                       <p class="form-control-static"><?php echo ($infos["area"]); ?></p>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12 clearfix">
                                           <div class="col-sm-12">
                                                <p class="form-control-static"><?php echo ($infos["desc"]); ?></p>
                                           </div>
...
<script type="text/javascript">  
	function editCompany(){
		$('#editCompany').load("/index.php?g=Qyapp&m=Hiring&mid=<?php echo $_GET['mid'];?>&a=editCompany", function(){
			 $('#editCompany').modal();
		});		   
	}
	function editInfo(){
		$('#editInfo').load("/index.php?g=Qyapp&m=Hiring&mid=<?php echo $_GET['mid'];?>&a=editInfo", function(){
			 $('#editInfo').modal();
		});		   
	}
	function introduce(){
		$('#introduce').load("/index.php?g=Qyapp&m=Hiring&mid=<?php echo $_GET['mid'];?>&a=introduce", function(){
			 $('#introduce').modal();
		});		   
	}
</script>   
