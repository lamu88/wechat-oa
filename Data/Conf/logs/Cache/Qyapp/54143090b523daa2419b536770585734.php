        ...
        <aside>
            <section class="vbox">
                ...
                <header class="header bg-white b-b clearfix">
                    <form class="talbe-search" method="POST" target="_self" action="<?php echo U('Meet/lists',array('mid'=>$_GET['mid']));?>" id="form">
					...
					<script type="text/javascript">
						$(document).ready(function() {
							...
							$('#reportrange span').html(moment().format('YYYY/MM/DD'));
                ...
                <section class="scrollable wrapper w-f">
                    <section class="panel panel-default ">
                        <div class="table-responsive">
                            <table class="table m-b-none entity-view text-center table-bordered" data-path="">
 								<colgroup>
								<col style="width:20%">
								<col style="width:4%">
								<col style="width:4%">
								...
								<thead>
                                    <tr>
                                        ...
                                        <th class="text-center" colspan='2'>8:00-9:00</th>
                                        <th class="text-center" colspan='2'>9:00-10:00</th>
                                ...
                                <tbody class="choose">																
								   <?php if($data): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($data["id"]); ?>">
										...
										<td <?php if($data['info']['t_8_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_8_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_9_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_9_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_10_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_10_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_11_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_11_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_12_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_12_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_13_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_13_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_14_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_14_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_15_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_15_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_16_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_16_2']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_17_1']): ?>style="background-color:green"<?php endif; ?> > </td>
										<td <?php if($data['info']['t_17_2']): ?>style="background-color:green"<?php endif; ?> > </td>									
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?> 
                                    <?php else: ?>											
                                     <tr>
                                        <td  colspan="5" class="nodata">暂无预订</td>
                                    </tr><?php endif; ?> 
                                </tbody>
                            </table>
                        </div>
...
<section class="entity-panel hd" id="meetInfo">
</section>
<script type="text/javascript">
$('#mytable tr').click(function(){
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
			var curId = $('#meetInfo').children().attr('id');			
		    if(curId == 'user'+userId){
				...
				$('#meetInfo').empty();   
				$('#meetInfo').load("index.php?g=Qyapp&m=Meet&a=meetInfo&mid=<?php echo $_GET['mid'];?>&id="+userId);
				$('.entity-panel').removeClass('hd');
