...
<!-- 	<div class="wrapper b-b header"><b>微信外勤</b></div>
	<ul class="nav">
		 ...
		 <li class="b-b b-light open"><a href="<?php echo U('Legwork/manage',array('id'=>$_GET['id']));?>"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>外勤管理</a></li>
		<li class="b-b b-light"><a href="<?php echo U('Legwork/realtime',array('id'=>$_GET['id']));?>"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>实时查岗</a></li>
		<li class="b-b b-light"><a href="<?php echo U('Legwork/setting',array('id'=>$_GET['id']));?>"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>设置</a></li>
		...
		<li class="b-b b-light"><a href="<?php echo U('Appmsg/conf',array('id'=>$_GET['id']));?>"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>应用管理</a></li>
           ...
           <aside>
            <section class="vbox">
                <header class="header bg-white b-b clearfix">
                    <form class="talbe-search" method="get"  target="_self" action="/fieldper/manage">
...
<!--                            </div>-->
                            <div class="col-sm-5 m-b-xs">
                                <a class="btn btn-default btn-sm " data-toggle="reportrange" data-change="submit">
                                    <i class="fa fa-calendar fa-lg"></i>
                                    <small>时间</small>
                                    <span>2015/01/12 - 2015/01/12</span> <b class="caret"></b>
                                    <input type="hidden" value="2015/01/12 - 2015/01/12" name="reportrange" />
                                </a>

                            </div>
                            <div class="col-sm-3 m-b-xs col-sm-offset-4">
                                <div class="input-group">
                                    <input type="text" class="input-sm form-control" name="keyword" placeholder="请输入关键字" value=""/>
                ...
                <section class="scrollable wrapper w-f">
                    <section class="panel panel-default ">
                        <div class="table-responsive">
                            <table class="table table-hover m-b-none entity-view" data-path="/fieldper/detail?pid={0}">
                                <thead>
                                    <tr>
...
<!--                                        </th>-->
								...
								<?php if($data): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($vo["id"]); ?>">
										...
										<td><?php echo (date("Y-m-d",$vo["checktime"])); ?></td>
										<td><?php echo ($vo["outplace"]); ?></td>
										<td><?php echo ($vo["long"]); ?>,<?php echo ($vo["lat"]); ?></td>
										
										<!-- <td>
											<a href="<?php echo U('info',array('id'=>$vo['id']));?>">
												<span class="dropdown-label" >查询详情</span>
											</a>
										</td> -->
                ...
                <footer class="footer bg-white b-t">
                    <div class="row text-center-xs">
                        <div class="col-md-6 hidden-sm">
                            <p class="text-muted m-t">总共0条 当前为第0页</p>
                        </div>
