                        ...
                        <div class="row m-t-sm">
                            <div class="col-sm-9 m-b-xs">
                                <div class="btn-group m-l">
                                     <a class="btn btn-sm btn-default  " href="<?php echo U('Hiring/reward',array('mid'=>$_GET['mid'],'status'=>1));?>" target="_self" title="悬赏记录">
                                        悬赏记录
                                    </a>
                                    <a class="btn btn-sm btn-default  " href="<?php echo U('Hiring/money_get',array('mid'=>$_GET['mid']));?>" target="_self" title="提现记录">
                                       提现记录
                                    </a>
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				//并ajax加载点击行的数据信息
				$('#info').load("index.php?g=Qyapp&m=Hiring&a=rewardInfo&mid=<?php echo $_GET['mid'];?>&id="+userId);
				$('.entity-panel').removeClass('hd');
