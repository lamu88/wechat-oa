        ...
        <aside>
            <section class="vbox">
                ...
                <header class="header bg-white b-b clearfix">
                    <form class="talbe-search" method="get" target="_self"  action="<?php echo U('Workflow/index',array('mid'=>$_GET['mid']));?>">
                           <div class="row m-t-sm">					
                            <div class="col-sm-4 m-b-xs">							
                                <div class="input-group">
                                    <div class="input-group-btn">
                                        <button class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                            <span class="dropdown-label" id="searchTypeTxt1">按用户ID查询</span>
                                            <span class="caret"></span>
                                        </button>
                                       <ul class="dropdown-menu dropdown-select js_select_search" id="searchMenu">
                                             <li >
                                                <a href="javascript:void();">
                                                    <input type="radio" value="0" name="searchBy"/>按订单号查询
                                                </a>
                                            </li> 
                                            <li >
                                                <a href="javascript:void();">
                                                    <input type="radio" value="1" name="searchBy" />按用户ID查询
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="input-group js_show_date js_show_date_0 " id="select_4" >
										<input type="text" class="form-control input-sm" name="username" id="searchUsername" value="" placeholder="请输入用户ID"/>
										<input type="text" class="form-control input-sm" style="display:none" name="mobile" id="depart" value="" placeholder="请输入订单号" />									
                    ...
                    <section class="panel panel-default ">
                        <div class="table-responsive">
                            <table class="table table-hover m-b-none entity-view">
                                ...
                                <tbody id="mytable">
								<?php if($data): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($data["rec_id"]); ?>">
                                            <td><?php echo ($data["order_id"]); ?></td>
                                            <td><?php echo ($data["goods_name"]); ?></td>
                                            <td><?php echo ($data["goods_number"]); ?></td>
                                            <td><?php echo ($data["goods_attr"]); ?></td>
