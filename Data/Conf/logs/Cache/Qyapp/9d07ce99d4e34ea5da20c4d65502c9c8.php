                    ...
                    <form class="talbe-search" target="_self" method="post" action="">
							<div class="row m-t-sm">
								<div class="col-sm-9 m-b-xs">
									<a class="btn btn-sm btn-default" href="<?php echo U('Attendance/addadress',array('mid'=>$_GET['mid']));?>" target="_self">
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				$('#info').load("index.php?g=Qyapp&m=Attendance&a=addressInfo&mid=<?php echo $_GET['mid'];?>&id="+userId);
				$('.entity-panel').removeClass('hd');
