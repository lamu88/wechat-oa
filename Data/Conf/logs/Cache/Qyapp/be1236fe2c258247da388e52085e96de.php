      ...
      <aside>
        <section class="vbox">
            ...
            <header class="header bg-white b-b clearfix">
                <form class="talbe-search" method="post" target="_self"  action="<?php echo U('Knowledge/index',array('mid'=>$_GET['mid']));?>" target="_self">
...
<!--                             <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <a href="<?php echo U('Knowledge/addFolder',array('mid'=>$_GET['mid']));?>" target="_self" class="btn btn-default btn-sm">新增文件夹<i class="fa fa-plus m-l-xs m-r-xs"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <section class="panel panel-default ">
                    <div class="table-responsive">
                        <table class="table table-hover m-b-none entity-view" data-path="/Knowledge/FolderDetail?fid={0}">
                            ...
                            <tbody id="mytable">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr data-id="113" id="<?php echo ($v["id"]); ?>">
                                    <td>
