                    ...
                    <section class="panel panel-default ">
                        <div class="table-responsive">
                            <table class="table table-hover m-b-none entity-view">
                                ...
                                <tbody id="mytable">
								<?php if($data): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr >
                                            <td><?php echo ($data["goods_id"]); ?></td>
                                            <td><?php echo ($data["goods_name"]); ?></td>
                                            <td><input style="border:0px;" id="input_<?php echo ($data["goods_id"]); ?>" data="<?php echo ($data["goods_id"]); ?>" placeholder="设置佣金比例" value="<?php echo ($data["scale"]); ?>"/></td>
