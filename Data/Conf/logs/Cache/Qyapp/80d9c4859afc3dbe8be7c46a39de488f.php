		...
		<li class="b-b b-light">
            ...
            <section class="vbox">
                <header class="header bg-white b-b clearfix">
                    <form class="talbe-search" method="get" target="_self" action="<?php echo U('Applyflow/applytype',array('mid'=>$_GET['mid']));?>">
...
<form class="form-horizontal form-validate form-modal" action="<?php echo U('Applyflow/add');?>" target="_self" method="post"> 
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				$('#info').load("index.php?g=Qyapp&m=Applyflow&a=applyinfo&id="+userId);
				$('.entity-panel').removeClass('hd');
