        ...
        <section class="scrollable  wrapper">
            <section class="panel panel-default">
                <div class="panel-body">
                    <form class="form-horizontal form-validate" method="post" action="<?php echo U('Userinfo/upfile');?>" target="_self">
					   <div class="form-group">
                            <label class="col-sm-2 control-label must">用户版本</label>
                            <div class="col-sm-3 ">
								<select onchange="changeuploadtype(this.value)" name="upload_type" class="form-control" >
								
								<option value="local" <?php if($data['upload_type'] == 'local'): ?>selected<?php endif; ?> >保存到本服务器</option>
								<option value="upyun" <?php if($data['upload_type'] == 'upyun'): ?>selected<?php endif; ?> >保存到又拍云</option>
								
								</select>
                            </div>
                        </div>
					       <div id="upload_bucket" <?php if(($data['upload_type'] == 'local') or ($data['upload_type'] == '') ): ?>style="display:none"<?php endif; ?> >
						   <div class="line line-dashed line-lg pull-in"></div>
						   <div class="form-group" >
								<label class="col-sm-2 control-label must">BUCKET：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_bucket"]); ?>" data-rule-required="true" name="up_bucket"/>
								</div>
							</div>
							</div>
							<div id="upload_secret" <?php if(($data['upload_type'] == 'local') or ($data['upload_type'] == '') ): ?>style="display:none"<?php endif; ?>  >
						 <div class="line line-dashed line-lg pull-in"></div>
						   <div class="form-group">
								<label class="col-sm-2 control-label must">FORM_API_SECRET：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_form_api_secret"]); ?>" data-rule-required="true" name="up_form_api_secret"/>
								</div>
							</div>
							</div>
							<div id="upload_username" <?php if(($data['upload_type'] == 'local') or ($data['upload_type'] == '') ): ?>style="display:none"<?php endif; ?> >
							<div class="line line-dashed line-lg pull-in"></div>
						   <div class="form-group">
								<label class="col-sm-2 control-label must">操作员：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_username"]); ?>" data-rule-required="true" name="up_username"/>
								</div>
							</div>
							</div>
							<div id="upload_password" <?php if(($data['upload_type'] == 'local') or ($data['upload_type'] == '') ): ?>style="display:none"<?php endif; ?> >
							<div class="line line-dashed line-lg pull-in"></div>
						  <div class="form-group">
								<label class="col-sm-2 control-label must">密码：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_password"]); ?>" data-rule-required="true" name="up_password"/>
								</div>
							</div>
							</div>
							<div id="upload_domain" <?php if(($data['upload_type'] == 'local') or ($data['upload_type'] == '') ): ?>style="display:none"<?php endif; ?> >
							<div class="line line-dashed line-lg pull-in"></div>
						<div class="form-group">
								<label class="col-sm-2 control-label must">云存储域名：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_domainname"]); ?>" data-rule-required="true" name="up_domainname"/>
								</div>
							</div>
							</div>
							<div class="line line-dashed line-lg pull-in"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label must">上传文件类型：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_exts"]); ?>" data-rule-required="true" name="up_exts"/>
								</div>
							</div>
						<div class="line line-dashed line-lg pull-in"></div>
                        <div class="form-group">
								<label class="col-sm-2 control-label must">文件大小：</label>
								<div class="col-sm-3 ">
									  <input type="text" class="form-control"   value="<?php echo ($data["up_size"]); ?>" data-rule-required="true" name="up_size"/>
								</div>
							</div>
