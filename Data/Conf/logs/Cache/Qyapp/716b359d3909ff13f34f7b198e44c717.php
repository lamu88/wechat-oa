...
$(document).ready(function(){ 
	$(".js_message_send").click(function() {
		...
		var subdata='type=image&content='+$('.sucai_img').attr('src')+'&agentid=<?php echo $_GET['id'];?>&departid='+departid;
...
$(document).ready(function(){ 
	$(".btn-primary").click(function() {
		...
		var subdata='';
		if(btn=="text"){
			subdata='type=text&usertype='+usertype+'&users='+users+'&content='+$('.input_edition_content').val()+'&agentid=<?php echo $_GET['id'];?>';
		}
		if(btn=="image"){
			subdata='type=image&usertype='+usertype+'&users='+users+'&content='+$('.sucai_img').attr("src")+'&agentid=<?php echo $_GET['id'];?>'+'&departid='+departid;
		}
		if(btn=="news"){
...
<section class="vbox ">
		...
		<header class="header bg-light">
			...
			<ul class="nav nav-tabs nav-white js_message_filetype">
				...
				<li class="active"><a href="<?php echo U('image_post',array('id'=>$_GET['id']));?>" target="_self" >图片</a></li>
