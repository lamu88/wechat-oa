        ...
        <section class="scrollable  wrapper">
            <section class="panel panel-default">
                <div class="panel-body">
                    <form class="form-horizontal form-validate" method="post" target="_self"  action="<?php echo U('Distribution/menu',array('mid'=>$_GET['mid']));?>">
                       
						<div class="form-group">
                            <label class="col-sm-2 control-label must">请设置域名</label>
                            <div class="col-sm-8 ">
                                <input class="form-control" data-rule-required="true" data-toggle="tokeninputtree" name="menu"   type="text" value="<?php echo ($menu["link"]); ?>"  /> 
								<br/>
								<p>请填写域名如：http://www.example.cn</p>
                            </div>
						...
						<div class="form-group">
                            <label class="col-sm-2 control-label must">请设置接口文件</label>
                            <div class="col-sm-4">
                                <input class="form-control" data-rule-required="true" data-toggle="tokeninputtree" name="file"   type="text" value=""  /> 
								<br/>
								<p>请填写接口文件如：example.php、example.asp等等（有关接口文件请咨询网站管理人员）</p>								
                            </div>
