        ...
        <aside>
			<section class="vbox">
                ...
                <header class="header bg-white b-b clearfix">
                    <form class="talbe-search" method="get"  target="_self" action="<?php echo U('Knowledge/addFiles',array('mid'=>$_GET['mid']));?>" id="Form">
...
<!--                                 <div class="btn-group">
                                ...
                                <div class="btn-group" style="display:none">
                                    <a href="<?php echo U('Knowledge/addFiles',array('mid'=>$_GET['mid']));?>" target="_self" class="btn btn-default btn-sm">上传文档</a>
                                </div>
                    ...
                    <section class="panel panel-default ">
                        <div class="table-responsive">
                            <table class="table table-hover m-b-none entity-view" data-path="/Knowledge/FileDetail?fid={0}&folder_id=">
                                ...
                                <tbody id="mytable">
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr id="<?php echo ($v["id"]); ?>">
										<!-- <td>
											<input type="checkbox" >
										</td> -->
...
<!--       <footer class="footer bg-white b-t">
                    <div class="row text-center-xs">
                        <div class="col-md-6 hidden-sm">
								<span>总签到数：<?php echo ($ctime); ?>天</span>&nbsp;&nbsp;
							    <span>总签退数：<?php echo ($otime); ?>天</span>&nbsp;&nbsp;								
								<span>迟到总数：<?php echo ($latetime); ?>小时</span>&nbsp;&nbsp;
								<span>早退总数：<?php echo ($earlytime); ?>小时</span> 
                        </div>
	...
	$(this).each(function(){
		...
		if($('#user'+userId).length>0){
		    ...
		    if(curId == 'user'+userId){
				...
				$('#info').empty();   
				$('#info').load("index.php?g=Qyapp&m=Knowledge&a=filesInfo&mid=<?php echo $_GET['mid'];?>&id="+userId);
				$('.entity-panel').removeClass('hd');
