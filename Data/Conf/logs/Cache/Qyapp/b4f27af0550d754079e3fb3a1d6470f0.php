			...
			<section class="scrollable wrapper w-f">
				<section class="panel panel-default ">
					<div class="row m-l-none m-r-none bg-light lter">
							...
							<div class="app-item">
									<a href="" target="_self">
										<img class="app-item-img" alt="企业小助手" src="./Tpl/Qyapp/Index/index/c51f09fc3e8b75752bb7857e26f3d4f3.png">
									</a>
									<div class="app-item-name">企业小助手</div>
								</div>
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="app-item">
									<a href="<?php echo U('Msg/group_post',array('id'=>$vo['id']));?>" target="_self">
