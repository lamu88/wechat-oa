                ...
                <div class="panel-body">
                    <form class="form-horizontal form-validate" method="post" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 ">
                                  <input type="text" value="<?php echo ($data["title"]); ?>" class="form-control"  data-rule-required="true" name="title"/>
                            </div>
                        </div>
						
                        <div class="line line-dashed line-lg pull-in"></div>
					   <div class="form-group">
                            <label class="col-sm-2 control-label must">应用数量：</label>
                            <div class="col-sm-3">
                                  <input type="text" class="form-control" value="<?php echo ($data["nums"]); ?>" data-rule-required="true" name="nums"/>
                            </div>
                        </div>
						
						<div class="line line-dashed line-lg pull-in"></div>
					   <div class="form-group">
                            <label class="col-sm-2 control-label must">包月价格：</label>
                            <div class="col-sm-3 ">
                                  <input type="text" class="form-control" value="<?php echo ($data["price"]); ?>" data-rule-required="true" name="price"/>
                            </div>
                        </div>
						  ...
						  <div class="form-group">
                            ...
                            <div class="col-sm-3 ">
                                 <div class="pull-left m-t-sm" id="mySwitch" style="width:500px;"> 
									...
									<span>关闭<input type="radio" name="status" value="0"></span>
									</div>
                            </div>
                        </div>
