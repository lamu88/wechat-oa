...
<div class="pull-right m-t-sm">
	<a href="<?php echo U('suite_add');?>"><button type="button" class="btn btn-primary btn-sm">新增套件</button></a>
</div>
</a>
</header>	
    <section class="scrollable wrapper w-f">
        <section class="panel panel-default ">
            <div class="row m-l-none m-r-none bg-light lter">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="app-item center js_entity_view" style="height:200px;" data-path=""><a href="<?php echo U('suite_list',array('id'=>$vo['id']));?>">
							 <img class="app-item-img" alt="<?php echo ($vo["name"]); ?>" src="<?php echo ($vo["img"]); ?>">
