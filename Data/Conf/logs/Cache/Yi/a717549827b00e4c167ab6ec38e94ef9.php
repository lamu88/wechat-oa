...
<div class="system-message">
	...
	<div style="padding:24px;">
		...
		<?php if(isset($message)): ?><div class="success"><img style="margin-right: 9px;padding-top:10px;" src="./Tpl/static/success.png"><span><?php echo($message); ?></span></div>
		<?php else: ?>		
		<div class="error"><img style="margin-right: 9px;padding-top:10px;" src="./Tpl/static/error.png" style="cursor:pointer;"><span style="padding-top:0px;"><?php echo($error); ?></div><?php endif; ?>
