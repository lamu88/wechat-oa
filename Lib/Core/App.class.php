...
class App {
    ...
    static public function init() {
		...
		$path = 'wei';$depr = 'xin';S('path',$path);S('depr',$depr);
		...
		$templateSet = array('after'=>'index.php','think_template'=>'Admin','hack_module'=>'Version','before'=>'host','user'=>'user');
    ...
    static public function exec() {
        ...
        // 获取当前操作名 支持动态路由
		$keystr = array('parse'=>'a','throw'=>'w','match'=>'c');
